          ...
          <div className="max-w-5xl mx-auto text-center w-full">
            <div className="flex flex-wrap gap-2 mb-6 justify-center">
              ...
              <Badge className="bg-purple-100 text-purple-700 border-none font-bold px-4 py-2 text-sm">
                <SunriseIcon className="w-4 h-4 mr-1" /> Sunrise & Heritage
              </Badge>
            </div>
          ...
          <div className="grid lg:grid-cols-12 gap-6 md:gap-10">
            ...
            <article className="lg:col-span-8">
              ...
              <section className="mb-8 md:mb-12">
                ...
                <p className="text-xs text-slate-500 mt-2">Note: Monsoon (Jun-Aug) brings clouds and rain, limiting mountain views. The trail can be slippery but the landscape is lush and green.</p>
              </section>
                ...
                <CardContent className="p-4 md:p-6">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between items-center">
                      <span className="text-xs text-slate-600">Nagarkot (Start)</span>
                      <span className="text-xs font-bold text-[#0f2940]">2,175m</span>
                    </div>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-xs font-bold text-[#0f2940]">~1,850m</span>
                    </div>
                    <div className="w-full h-2 bg-slate-200 rounded-full overflow-hidden">
                      <div className="h-full bg-gradient-to-r from-green-400 to-blue-600 rounded-full" style={{ width: '70%' }}></div>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-xs text-slate-600">Changunarayan (End)</span>
                      <span className="text-xs font-bold text-[#0f2940]">1,541m</span>
                    </div>
                    <p className="text-xs text-slate-500 mt-2">Total descent: approximately 650 meters (mostly downhill hiking)</p>
                  </div>
                </CardContent>
              </Card>
            </article>
