...
export default function NagarkotChangunarayanHikingPage() {
  ...
  const productSchema = {
    ...
    "@type": "Product",
    "name": "Nagarkot-Changunarayan Hiking Adventure",
    "description": "A spectacular day hike combining a Himalayan sunrise from Nagarkot with a scenic downhill trek through villages and forests to the 4th-century Changunarayan Temple UNESCO site.",
    "image": "https://www.himkalaadventure.com/images/used/nagarkot-changu.webp",
    "brand": {
      "@type": "Brand",
    ...
    "offers": {
      ...
      "url": "https://www.himkalaadventure.com/services/day-hikings/nagarkot-changunarayan-hiking"
    },
    "aggregateRating": {
  ...
  const organizationSchema = {
    ...
    "name": "Himkala Adventure Pvt. Ltd.",
    "description": "Expert-guided day hikes in Nepal including Nagarkot-Changunarayan hiking adventure with sunrise views and cultural heritage.",
    "address": {
      "@type": "PostalAddress",
          ...
          <div className="max-w-5xl mx-auto text-center w-full">
            <div className="flex flex-wrap gap-2 mb-4 md:mb-6 justify-center">
              ...
              <Badge className="bg-purple-100 text-purple-700 border-none font-bold px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm">
                <SunriseIcon className="w-3 h-3 mr-1" aria-hidden="true" /> Sunrise & Heritage
              </Badge>
            </div>
        ...
        <div className="container mx-auto px-3 md:px-6 max-w-full">
          ...
          <div className="lg:hidden sticky top-0 z-30 bg-white border-b border-[#C5E0ED]/30 shadow-sm py-2 -mx-3 px-3">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-xs text-slate-400 line-through">$60</div>
                <div className="text-lg font-bold text-[#0f2940]">$45</div>
              </div>
                  ...
                  <Card className="bg-gradient-to-br from-[#0f2940] to-[#1a4166] border-none rounded-xl md:rounded-2xl overflow-hidden">
                    <CardContent className="p-4 md:p-6">
                      <div className="text-center mb-4 md:mb-6">
                        <span className="text-white/50 text-sm line-through">$60</span>
                        <div className="text-3xl md:text-4xl font-bold text-white mt-1">$45</div>
                      ...
                      <a 
                        ...
                        aria-label="Inquire about Nagarkot hiking on WhatsApp"
                      >
            ...
            <article className="lg:col-span-8 w-full overflow-hidden mt-6 lg:mt-0">
              ...
              <section className="mb-6 md:mb-12" id="highlights">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 md:gap-3">
                  {[
                    ...
                    >
                      <SunriseIcon className="w-3 h-3 md:w-4 h-4 text-[#2d6a8a] shrink-0" aria-hidden="true" />
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg md:rounded-2xl p-3 md:p-6 mb-6 md:mb-12">
                <h3 className="font-bold text-amber-800 mb-2 flex items-center gap-2 text-xs md:text-base">
                  <SunriseIcon className="w-4 h-4 md:w-5 md:h-5" aria-hidden="true" /> Nagarkot - The Sunrise Viewpoint
                </h3>
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg md:rounded-2xl p-3 md:p-6 mb-6 md:mb-12">
                <h3 className="font-bold text-green-800 mb-2 flex items-center gap-2 text-xs md:text-base">
                  <Landmark className="w-4 h-4 md:w-5 md:h-5" aria-hidden="true" /> Changunarayan Temple - Nepal's Oldest Temple
                </h3>
                <div className="grid md:grid-cols-2 gap-3">
                  <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-1 md:gap-3">
                  {gallery.map((image, i) => (
                    ...
                    >
                      <Image
                        src={image.src}
                        alt={`${image.alt} - Nagarkot-Changunarayan hiking trail in Nepal`}
                        fill
