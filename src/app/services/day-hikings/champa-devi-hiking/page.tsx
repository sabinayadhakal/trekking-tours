...
export default function ChampaDeviHikingPage() {
  ...
  const productSchema = {
    ...
    "@type": "Product",
    "name": "Champa Devi Hiking Adventure",
    "description": "A rewarding day hike to the highest peak in the southern Kathmandu Valley at 2,250m. Enjoy panoramic views, lush forests, traditional villages, and a peaceful picnic with Himalayan vistas.",
    "image": "https://www.himkalaadventure.com/images/used/champadevi-1.webp",
    "brand": {
      "@type": "Brand",
    ...
    "offers": {
      ...
      "url": "https://www.himkalaadventure.com/services/day-hikings/champa-devi-hiking"
    },
    "aggregateRating": {
  ...
  const organizationSchema = {
    ...
    "name": "Himkala Adventure Pvt. Ltd.",
    "description": "Expert-guided day hikes in Nepal including Champa Devi hiking adventure in the Kathmandu Valley.",
    "address": {
      "@type": "PostalAddress",
    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
          ...
          <div className="max-w-5xl mx-auto text-center w-full">
            <div className="flex flex-wrap gap-2 mb-4 md:mb-6 justify-center">
              ...
              <Badge className="bg-purple-100 text-purple-700 border-none font-bold px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm">
                <Eye className="w-3 h-3 mr-1" aria-hidden="true" /> Valley Panorama
              </Badge>
            </div>
      ...
      <section className="py-6 md:py-12 relative">
        <div className="container mx-auto px-3 md:px-6 max-w-full">
          ...
          {/* Desktop Layout - Grid with sticky sidebar - FIXED */}
<div className="lg:grid lg:grid-cols-12 lg:gap-4 lg:gap-10">
{/* Sidebar - Static/Fixed (DOES NOT MOVE AT ALL) */}
    ...
    <Card className="bg-gradient-to-br from-[#0f2940] to-[#1a4166] border-none rounded-xl md:rounded-2xl overflow-hidden">
      <CardContent className="p-4 md:p-6">
        <div className="text-center mb-4 md:mb-6">
          ...
          <Badge className="ml-2 bg-green-500/20 text-green-300 border-none text-[8px] md:text-xs">Save $10</Badge>
        </div>
        ...
        <a 
          ...
          aria-label="Inquire about Champa Devi hiking on WhatsApp"
        >
              ...
              <section className="mb-6 md:mb-12" id="highlights">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 md:gap-3">
                  {[
                    ...
                    >
                      <Footprints className="w-3 h-3 md:w-4 h-4 text-[#2d6a8a] shrink-0" aria-hidden="true" />
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-1 md:gap-3">
                  {gallery.map((image, i) => (
                    ...
                    >
                      <Image
                        src={image.src}
                        alt={`${image.alt} - Champa Devi hiking trail in Nepal`}
                        fill
