...
export default function YalaPeakClimbingPage() {
  ...
  const handleShare = (platform: string) => {
    ...
    const title = encodeURIComponent("Yala Peak Climbing - Himkala Adventure");
    let shareUrl = "";
          ...
          <div className="max-w-5xl mx-auto text-center w-full">
            <div className="flex flex-wrap gap-2 mb-6 justify-center">
              ...
              <Badge className="bg-purple-100 text-purple-700 border-none font-bold px-4 py-2 text-sm">
                <MountainSnow className="w-4 h-4 mr-1" /> 5,732m Summit
              </Badge>
            </div>
          ...
          <div className="grid lg:grid-cols-12 gap-6 md:gap-10">
                ...
                <Card className="bg-gradient-to-br from-[#0f2940] to-[#1a4166] border-none rounded-xl md:rounded-2xl overflow-hidden">
                  <CardContent className="p-4 md:p-6">
                    <div className="text-center mb-4 md:mb-6">
                      ...
                      <Badge className="ml-2 bg-green-500/20 text-green-300 border-none text-xs">Save $205</Badge>
                    </div>
            ...
            <article className="lg:col-span-8">
              ...
              <section className="mb-8 md:mb-12">
                ...
                <p className="text-xs text-slate-500 mt-2">Note: Winter (Dec-Feb) is very cold with heavy snow. Monsoon (Jun-Aug) brings rain, clouds, and leeches - not recommended for climbing.</p>
              </section>
