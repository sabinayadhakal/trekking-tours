...
export default function MeraPeakClimbingPage() {
  ...
  const handleShare = (platform: string) => {
    ...
    const title = encodeURIComponent("Mera Peak Climbing - Himkala Adventure");
    let shareUrl = "";
          ...
          <div className="max-w-5xl mx-auto text-center w-full">
            <div className="flex flex-wrap gap-2 mb-6 justify-center">
              <Badge className="bg-gradient-to-r from-[#C5E0ED] to-[#9dcae0] text-[#0f2940] border-none font-bold px-4 py-2 text-sm">
                <MapPin className="w-4 h-4 mr-1" /> Makalu Region
              </Badge>
              ...
              <Badge className="bg-purple-100 text-purple-700 border-none font-bold px-4 py-2 text-sm">
                <MountainSnow className="w-4 h-4 mr-1" /> 6,476m Summit
              </Badge>
            </div>
          ...
          <div className="grid lg:grid-cols-12 gap-6 md:gap-10">
              ...
              <div className="container mx-auto px-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-xl font-bold text-[#0f2940]">$3,195</div>
                  </div>
                  <Link href="/contact">
            ...
            <article className="lg:col-span-8">
              ...
              <section className="mb-8 md:mb-12">
                ...
                <p className="text-xs text-slate-500 mt-2">Note: Winter (Dec-Feb) is extremely cold with heavy snow and high avalanche risk. Monsoon (Jun-Aug) brings rain, clouds, and poor summit visibility - not recommended.</p>
              </section>
