...
const gallery = [
  ...
  },
  {
    ...
    alt: "Kala Patthar Sunrise",
    caption: "Sunrise from Kala Patthar",
  },
  {
              ...
              <div className="container mx-auto px-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-xl font-bold text-[#0f2940]">$1,250</div>
                  </div>
                  <Link href="/contact">
              ...
              <section className="mb-8 md:mb-12" id="overview">
                ...
                <div className="prose prose-slate max-w-none">
                  <p className="text-slate-600 leading-relaxed mb-3 md:mb-4 text-sm md:text-base">
                    ...
                    This iconic trek follows in the footsteps of legendary climbers through the heart of 
                    Sherpa country, offering unparalleled mountain scenery and rich cultural experiences.
                  </p>
                  <p className="text-slate-600 leading-relaxed mb-3 md:mb-4 text-sm md:text-base">
