...
export default function ManasluTsumValleyTrekPage() {
  ...
  const orgSchema = {
    ...
    "description": "Expert-guided Manaslu Circuit with Tsum Valley trekking packages in Nepal. Explore sacred Tsum Valley and cross Larkya La Pass with certified guides.",
    "address": {
      "@type": "PostalAddress",
  ...
  const trekSchema = {
    "@context": "https://schema.org",
    "@type": "Product",
    "name": "Manaslu Circuit with Tsum Valley Trek - 17 Days",
    "description": "Manaslu Circuit with Tsum Valley Trek: Explore the sacred Tsum Valley, visit ancient monasteries including Mu Gompa, and cross Larkya La Pass at 5,106m. The ultimate Manaslu adventure in Nepal.",
    "image": imageUrl,
    "brand": {
      "@type": "Brand",
      "name": "Himkala Adventure Pvt. Ltd."
    ...
    "additionalProperty": [
      ...
      {
        "@type": "PropertyValue",
        "name": "Mount Manaslu Altitude",
        "value": "8,163m"
      },
      {
        "@type": "PropertyValue",
        "name": "Mu Gompa Altitude",
        "value": "3,700m"
      },
      {
        "@type": "PropertyValue",
      ...
      },
      {
        "@type": "PropertyValue",
        "name": "Trek Type",
        "value": "Restricted Area Trek - Tsum Valley + Manaslu Circuit"
      }
    ]
  };
            ...
            <div className="max-w-5xl mx-auto text-center w-full">
              <div className="flex flex-wrap gap-2 mb-4 md:mb-6 justify-center">
                ...
                <Badge className="bg-purple-100 text-purple-700 border-none font-bold px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm">
                  <Landmark className="w-3 h-3 mr-1" aria-hidden="true" /> Tsum Valley
                </Badge>
              </div>
            ...
            <div className="lg:grid lg:grid-cols-12 lg:gap-4 lg:gap-10">
                    ...
                    <Card className="bg-gradient-to-br from-[#0f2940] to-[#1a4166] border-none rounded-xl md:rounded-2xl overflow-hidden">
                      <CardContent className="p-4 md:p-6">
                        ...
                        <a 
                          ...
                          className="block"
                          aria-label="Inquire about Manaslu Circuit with Tsum Valley trek on WhatsApp"
                        >
              ...
              <article className="lg:col-span-8 w-full overflow-hidden mt-6 lg:mt-0">
                ...
                <section className="mb-6 md:mb-12" id="overview">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Overview of Manaslu Circuit with Tsum Valley Trek</h2>
                  <div className="prose prose-slate max-w-none">
                    <p className="text-slate-600 leading-relaxed mb-2 md:mb-4 text-xs md:text-base">
                      The <strong>Manaslu Circuit with Tsum Valley Trek</strong> is one of Nepal's most authentic and rewarding Himalayan adventures, combining the sacred Tsum Valley with the classic Manaslu Circuit. This comprehensive <strong>Manaslu Circuit with Tsum Valley trekking</strong> journey takes you through two restricted regions rich in Tibetan Buddhist culture, culminating in the crossing of the legendary <strong>Larkya La Pass (5,106m)</strong> with spectacular views of Mount Manaslu (8,163m), the world's eighth highest peak.
                    </p>
                    <p className="text-slate-600 leading-relaxed mb-2 md:mb-4 text-xs md:text-base">
                ...
                <section className="mb-6 md:mb-12" id="highlights">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Manaslu Circuit with Tsum Valley Trek Highlights</h2>
                ...
                <section className="mb-6 md:mb-12">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Best Time to Trek Manaslu Circuit with Tsum Valley</h2>
                ...
                <section className="mb-6 md:mb-12" id="itinerary">
                  <div className="flex items-center justify-between mb-3 md:mb-6">
                    <h2 className="text-lg md:text-2xl font-serif text-[#0f2940]">Day-by-Day Manaslu Circuit with Tsum Valley Itinerary</h2>
                    <Button
                      variant="outline"
                      size="sm"
                ...
                <section className="mb-6 md:mb-12" id="includes">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">What's Included in This Manaslu Circuit with Tsum Valley Trek</h2>
                ...
                <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-4">Important Information for Manaslu Circuit with Tsum Valley Trek</h2>
                ...
                <section className="mb-6 md:mb-12" id="gallery">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Photo Gallery - Manaslu Circuit with Tsum Valley Trek</h2>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-1 md:gap-3">
                    {gallery.map((image, i) => (
                      ...
                      >
                        <Image
                          src={image.src}
                          alt={`${image.alt} - Manaslu Circuit with Tsum Valley trekking experience in Nepal's Manaslu region`}
                          fill
                ...
                <section className="mb-6 md:mb-12" id="faq">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Frequently Asked Questions About Manaslu Circuit with Tsum Valley Trek</h2>
