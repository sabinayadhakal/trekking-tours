...
const itinerary = [
  ...
  },
  {
    ...
    description: "Today we leave the Langtang Valley and head toward the Gosainkunda region. The trail climbs through rhododendron and oak forests, crossing ridges with spectacular views back toward the Langtang range. We pass through several small settlements before reaching Thulo Syabru, a beautiful Tamang village perched on a ridge with stunning mountain views. The village offers a chance to experience authentic Tamang culture, with traditional houses, ancient gompas, and friendly locals. The sunset views over the Himalayas from here are spectacular.",
    overnight: "Teahouse in Thulo Syabru",
    meals: "Breakfast, Lunch, Dinner",
    highlights: ["Rhododendron and oak forests", "Views back to Langtang range", "Thulo Syabru village", "Authentic Tamang culture"],
  },
  {
    day: 9,
  ...
  {
    day: 10,
    title: "Trek to Gosainkunda Lake",
    altitude: "3,250m → 4,380m",
    distance: "12km / 6-7 hrs",
    description: "The most challenging day of the trek as we climb steadily to the sacred Gosainkunda Lakes. The trail passes through Laurebina Yak pastures before reaching Laurebina Pass (4,610m), marked with prayer flags and offering spectacular views of the lakes and surrounding peaks. The descent brings us to the main Gosainkunda Lake (4,380m), one of the most sacred Hindu pilgrimage sites in Nepal. According to legend, the lake was created by Lord Shiva when he thrust his trident into the mountain to obtain water to quench his thirst after swallowing poison. The deep blue waters surrounded by barren peaks create a mystical atmosphere. Visit the temples on the lakeshore and witness the ritual offerings made by pilgrims. The setting is especially dramatic in autumn and spring.",
    overnight: "Teahouse at Gosainkunda",
    meals: "Breakfast, Packed Lunch, Dinner",
    highlights: ["Laurebina Pass (4,610m)", "Sacred Gosainkunda Lake", "Hindu pilgrimage site", "Lord Shiva legend", "Dramatic mountain setting"],
  },
  {
    day: 11,
    title: "Exploration Day - Saraswati Kunda & Bhairab Kunda",
    altitude: "4,380m → 4,500m → 4,380m",
    distance: "6-8km / 3-4 hrs",
    description: "A rest and exploration day to fully experience the sacred lake region. Take short hikes to smaller lakes including Saraswati Kunda (dedicated to the goddess of learning) and Bhairab Kunda (dedicated to the fierce manifestation of Shiva). These lakes offer different perspectives of the Gosainkunda basin and are equally sacred to pilgrims. The morning light on the lakes is magical, with reflections of the surrounding peaks. Interact with pilgrims who have journeyed here for blessings, and learn about the various legends associated with each lake. The afternoon is free for rest, photography, and soaking in the spiritual atmosphere of this unique Himalayan sanctuary.",
    overnight: "Teahouse at Gosainkunda",
    meals: "Breakfast, Lunch, Dinner",
    highlights: ["Saraswati Kunda", "Bhairab Kunda", "Pilgrim interactions", "Lake reflections", "Spiritual atmosphere"],
  },
  {
    day: 12,
    title: "Trek to Ghopte",
    altitude: "4,380m → 3,440m",
    distance: "14km / 6-7 hrs",
    description: "We leave the sacred lakes behind and continue our journey eastward. The trail crosses another pass at 4,600m before descending through rocky terrain with spectacular mountain views. The landscape is barren and dramatic, with occasional glimpses of Himalayan tahr and other wildlife. We descend through forests of rhododendron and juniper to Ghopte, a small settlement with basic teahouses nestled in a valley. This remote area offers a true wilderness experience with few trekkers and pristine nature.",
    overnight: "Teahouse in Ghopte",
    meals: "Breakfast, Lunch, Dinner",
    highlights: ["High mountain pass crossing", "Dramatic rocky landscape", "Wildlife spotting", "Remote wilderness"],
  },
  {
    day: 13,
          ...
          <div className="max-w-5xl mx-auto text-center w-full">
            <div className="flex flex-wrap gap-2 mb-6 justify-center">
              ...
              <Badge className="bg-blue-100 text-blue-700 border-none font-bold px-4 py-2 text-sm">
                <Droplets className="w-4 h-4 mr-1" /> Sacred Lakes
              </Badge>
            </div>
          ...
          <div className="grid lg:grid-cols-12 gap-6 md:gap-10">
              ...
              <div className="container mx-auto px-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-xl font-bold text-[#0f2940]">$1,695</div>
                  </div>
                  <Link href="/contact">
            ...
            <article className="lg:col-span-8">
              ...
              <section className="mb-8 md:mb-12">
                ...
                <p className="text-xs text-slate-500 mt-2">Note: Winter (Dec-Feb) is very cold with heavy snow at higher elevations - passes may be closed. Monsoon (Jun-Aug) brings leeches and landslides but lush greenery .</p>
              </section>
