...
const gallery = [
  {
    ...
    alt: "Sacred Gosainkunda Lake at 4,380m - holy Hindu pilgrimage site in Nepal's Langtang region with turquoise waters",
  ...
  },
  {
    ...
    alt: "Langtang Valley and Village - traditional Tamang village in the Valley of Glaciers with Himalayan mountain views in Nepal",
...
export default function LangtangGosainkundaTrekPage() {
  ...
  const canonicalUrl = "https://www.himkalaadventure.com/langtang-gosainkunda-trek";
  const pageTitle = "Langtang-Gosainkunda Trek - Himkala Adventure";
  const pageDescription = "Langtang-Gosainkunda Trek: Trek to the sacred Gosainkunda Lakes at 4,380m and explore the Langtang Valley. A challenging Himalayan adventure in Nepal. Book now!";
  const imageUrl = "https://www.himkalaadventure.com/images/used/gosaikunda-1.webp";
  ...
  const orgSchema = {
    ...
    "description": "Expert-guided Langtang-Gosainkunda trekking packages in Nepal. Trek to the sacred Gosainkunda Lakes at 4,380m with certified guides.",
    "address": {
      "@type": "PostalAddress",
  ...
  const trekSchema = {
    ...
    "description": "Langtang-Gosainkunda Trek: Trek to the sacred Gosainkunda Lakes at 4,380m and explore the Langtang Valley. A challenging journey through Nepal's diverse landscapes with high passes and spiritual sites.",
    "image": imageUrl,
    "brand": {
      "@type": "Brand",
      "name": "Himkala Adventure Pvt. Ltd."
    ...
    "additionalProperty": [
      ...
      {
        "@type": "PropertyValue",
        "name": "Gosainkunda Lake Altitude",
        "value": "4,380m"
      },
      {
        "@type": "PropertyValue",
      ...
      },
      {
        ...
        "value": "Sacred Gosainkunda Lakes, Langtang Valley, Kyanjin Gompa, Laurebina Pass, Helambu Region"
      }
    ]
  };
      ...
      <div className="min-h-screen bg-white overflow-x-hidden">
        ...
        <section className="relative h-[45vh] min-h-[380px] md:h-[60vh] md:min-h-[500px] overflow-hidden bg-[#0f2940]">
          <div className="absolute inset-0 z-0">
            <Image
              src="/images/used/gosaikunda-1.webp"
              alt="Langtang-Gosainkunda Trek - sacred Gosainkunda Lake at 4,380m in Nepal's Langtang region with stunning Himalayan mountain reflections"
              fill
            ...
            <div className="max-w-5xl mx-auto text-center w-full">
              <div className="flex flex-wrap gap-2 mb-4 md:mb-6 justify-center">
                ...
                <Badge className="bg-blue-100 text-blue-700 border-none font-bold px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm">
                  <Droplets className="w-3 h-3 mr-1" aria-hidden="true" /> Sacred Lakes
                </Badge>
              </div>
            ...
            <div className="lg:grid lg:grid-cols-12 lg:gap-4 lg:gap-10">
                    ...
                    <Card className="bg-gradient-to-br from-[#0f2940] to-[#1a4166] border-none rounded-xl md:rounded-2xl overflow-hidden">
                      <CardContent className="p-4 md:p-6">
                        ...
                        <a 
                          ...
                          className="block"
                          aria-label="Inquire about Langtang-Gosainkunda trek on WhatsApp"
                        >
              ...
              <article className="lg:col-span-8 w-full overflow-hidden mt-6 lg:mt-0">
                ...
                <section className="mb-6 md:mb-12" id="overview">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Overview of Langtang-Gosainkunda Trek</h2>
                  <div className="prose prose-slate max-w-none">
                    <p className="text-slate-600 leading-relaxed mb-2 md:mb-4 text-xs md:text-base">
                      The <strong>Langtang-Gosainkunda Trek</strong> is one of Nepal's most diverse and rewarding treks, combining the stunning mountain scenery of the Langtang Valley with the sacred high-altitude lakes of Gosainkunda. This epic <strong>Langtang-Gosainkunda trekking</strong> journey takes you through lush forests, traditional Tamang villages, yak pastures, and across high Himalayan passes, culminating at one of the most important Hindu pilgrimage sites in the Himalayas.
                    </p>
                    <p className="text-slate-600 leading-relaxed mb-2 md:mb-4 text-xs md:text-base">
                ...
                <section className="mb-6 md:mb-12" id="highlights">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Langtang-Gosainkunda Trek Highlights</h2>
                ...
                <section className="mb-6 md:mb-12">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Best Time to Trek Langtang-Gosainkunda</h2>
                ...
                <section className="mb-6 md:mb-12" id="itinerary">
                  <div className="flex items-center justify-between mb-3 md:mb-6">
                    <h2 className="text-lg md:text-2xl font-serif text-[#0f2940]">Day-by-Day Langtang-Gosainkunda Itinerary</h2>
                    <Button
                      variant="outline"
                      size="sm"
                ...
                <section className="mb-6 md:mb-12" id="includes">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">What's Included in This Langtang-Gosainkunda Trek</h2>
                ...
                <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-4">Important Information for Langtang-Gosainkunda Trek</h2>
                ...
                <section className="mb-6 md:mb-12" id="gallery">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Photo Gallery - Langtang-Gosainkunda Trek</h2>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-1 md:gap-3">
                    {gallery.map((image, i) => (
                      ...
                      >
                        <Image
                          src={image.src}
                          alt={`${image.alt} - Langtang-Gosainkunda trekking experience in Nepal's Langtang region`}
                          fill
                ...
                <section className="mb-6 md:mb-12" id="faq">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Frequently Asked Questions About Langtang-Gosainkunda Trek</h2>
