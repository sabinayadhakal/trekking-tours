          ...
          <div className="max-w-5xl mx-auto text-center w-full">
            <div className="flex flex-wrap gap-2 mb-6 justify-center">
              ...
              <Badge className="bg-blue-100 text-blue-700 border-none font-bold px-4 py-2 text-sm">
                <Droplets className="w-4 h-4 mr-1" /> Khayar Lake
              </Badge>
            </div>
              ...
              <div className="container mx-auto px-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-xl font-bold text-[#0f2940]">$975</div>
                  </div>
                  <Link href="/contact">
                ...
                <Card className="bg-gradient-to-br from-[#0f2940] to-[#1a4166] border-none rounded-xl md:rounded-2xl overflow-hidden">
                  <CardContent className="p-4 md:p-6">
                    <div className="text-center mb-4 md:mb-6">
                      ...
                      <Badge className="ml-2 bg-green-500/20 text-green-300 border-none text-xs">Save $175</Badge>
                    </div>
              ...
              <section className="mb-8 md:mb-12" id="overview">
                ...
                <div className="prose prose-slate max-w-none">
                  <p className="text-slate-600 leading-relaxed mb-3 md:mb-4 text-sm md:text-base">
                    ...
                    offering a peaceful alternative to the more crowded trekking routes like Annapurna Base Camp. 
