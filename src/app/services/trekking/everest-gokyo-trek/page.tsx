...
const gallery = [
  {
    ...
    alt: "Turquoise Gokyo Lakes - the world's highest freshwater lake system in Nepal's Everest region",
    caption: "Turquoise Gokyo Lakes",
  },
  {
    src: "/images/used/gokyo-2.webp",
    alt: "Gokyo Ri summit view - panoramic Himalayan panorama with Everest, Lhotse, and Cho Oyu in Nepal",
    caption: "Gokyo Ri Summit View",
  },
  {
    src: "/images/used/gokyo-3.webp",
    alt: "Mount Everest from Gokyo Ri - the world's highest mountain viewed from the stunning Gokyo Valley in Nepal",
...
export default function EverestGokyoTrekPage() {
  ...
  const trekName = "Everest Gokyo Lakes Trek";
  const canonicalUrl = "https://www.himkalaadventure.com/everest-gokyo-lakes-trek";
  const pageTitle = "Everest Gokyo Lakes Trek - Himkala Adventure";
  const pageDescription = "Everest Gokyo Lakes Trek: Visit the turquoise Gokyo Lakes, cross Cho La Pass at 5,420m, and reach Everest Base Camp. The ultimate Everest adventure. Book now!";
  const imageUrl = "https://www.himkalaadventure.com/images/used/gokyo-1.webp";
  ...
  const orgSchema = {
    ...
    "description": "Expert-guided Everest Gokyo Lakes trekking packages in Nepal. Trek to the turquoise Gokyo Lakes, cross Cho La Pass, and reach Everest Base Camp with certified guides.",
    "address": {
      "@type": "PostalAddress",
  ...
  const trekSchema = {
    "@context": "https://schema.org",
    "@type": "Product",
    "name": "Everest Gokyo Lakes Trek - 14 Days",
    "description": "Everest Gokyo Lakes Trek: Visit the turquoise Gokyo Lakes (world's highest freshwater lakes), cross Cho La Pass at 5,420m, and reach Everest Base Camp at 5,364m. The ultimate Everest adventure.",
    "image": imageUrl,
    "brand": {
      "@type": "Brand",
      "name": "Himkala Adventure Pvt. Ltd."
    ...
    "additionalProperty": [
      ...
      {
        "@type": "PropertyValue",
        "name": "Gokyo Ri Altitude",
        "value": "5,357m"
      },
      {
        "@type": "PropertyValue",
        "name": "Cho La Pass Altitude",
        "value": "5,420m"
      },
      {
        "@type": "PropertyValue",
      ...
      <div className="min-h-screen bg-white overflow-x-hidden">
        ...
        <section className="relative h-[45vh] min-h-[380px] md:h-[60vh] md:min-h-[500px] overflow-hidden bg-[#0f2940]">
          <div className="absolute inset-0 z-0">
            <Image
              src="/images/used/gokyo-1.webp"
              alt="Everest Gokyo Lakes Trek - turquoise glacial lakes in Nepal's Everest region with stunning Himalayan mountain views"
              fill
            ...
            <div className="max-w-5xl mx-auto text-center w-full">
              <div className="flex flex-wrap gap-2 mb-4 md:mb-6 justify-center">
                ...
                <Badge className="bg-blue-100 text-blue-700 border-none font-bold px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm">
                  <Droplets className="w-3 h-3 mr-1" aria-hidden="true" /> Gokyo Lakes
                </Badge>
              </div>
            ...
            <div className="lg:grid lg:grid-cols-12 lg:gap-4 lg:gap-10">
                    ...
                    <Card className="bg-gradient-to-br from-[#0f2940] to-[#1a4166] border-none rounded-xl md:rounded-2xl overflow-hidden">
                      <CardContent className="p-4 md:p-6">
                        ...
                        <a 
                          ...
                          className="block"
                          aria-label="Inquire about Everest Gokyo Lakes trek on WhatsApp"
                        >
              ...
              <article className="lg:col-span-8 w-full overflow-hidden mt-6 lg:mt-0">
                ...
                <section className="mb-6 md:mb-12" id="overview">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Overview of Everest Gokyo Lakes Trek</h2>
                  <div className="prose prose-slate max-w-none">
                    <p className="text-slate-600 leading-relaxed mb-2 md:mb-4 text-xs md:text-base">
                      ...
                      waters of the Gokyo Lakes. This <strong>Everest Gokyo Lakes trekking</strong> adventure takes you 
                      to the sacred <strong>Gokyo Valley</strong>, home to the world's highest freshwater lake system.
                    </p>
                    <p className="text-slate-600 leading-relaxed mb-2 md:mb-4 text-xs md:text-base">
                ...
                <section className="mb-6 md:mb-12" id="highlights">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Everest Gokyo Lakes Trek Highlights</h2>
                ...
                <section className="mb-6 md:mb-12">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Best Time to Trek Everest Gokyo Lakes</h2>
                ...
                <section className="mb-6 md:mb-12" id="itinerary">
                  <div className="flex items-center justify-between mb-3 md:mb-6">
                    <h2 className="text-lg md:text-2xl font-serif text-[#0f2940]">Day-by-Day Everest Gokyo Lakes Itinerary</h2>
                    <Button
                      variant="outline"
                      size="sm"
                ...
                <section className="mb-6 md:mb-12" id="includes">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">What's Included in This Everest Gokyo Lakes Trek</h2>
                ...
                <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-4">Important Information for Everest Gokyo Lakes Trek</h2>
                ...
                <section className="mb-6 md:mb-12" id="gallery">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Photo Gallery - Everest Gokyo Lakes Trek</h2>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-1 md:gap-3">
                    {gallery.map((image, i) => (
                      ...
                      >
                        <Image
                          src={image.src}
                          alt={`${image.alt} - Everest Gokyo Lakes trekking experience in Nepal's Everest region`}
                          fill
                ...
                <section className="mb-6 md:mb-12" id="faq">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Frequently Asked Questions About Everest Gokyo Lakes Trek</h2>
