...
const gallery = [
  {
    ...
    alt: "Lo Manthang - the ancient walled capital of the Mustang Kingdom with traditional Tibetan Buddhist architecture in Nepal",
    caption: "Lo Manthang - The Walled Capital",
  },
  {
    src: "/images/used/upper-mustang-2.webp",
    alt: "Upper Mustang high-altitude desert landscape with dramatic red cliffs and barren terrain in Nepal's forbidden kingdom",
...
export default function UpperMustangTrekPage() {
  ...
  const canonicalUrl = "https://www.himkalaadventure.com/upper-mustang-forbidden-kingdom-trek";
  const pageTitle = "Upper Mustang Forbidden Kingdom Trek - Himkala Adventure";
  const pageDescription = "Upper Mustang Forbidden Kingdom Trek: Explore Lo Manthang, sky caves, and preserved Tibetan Buddhist culture. A restricted area adventure in Nepal. Book now!";
  const imageUrl = "https://www.himkalaadventure.com/images/used/upper-mustang-main-page.webp";
  ...
  const handleShare = (platform: string) => {
    ...
    const title = encodeURIComponent("Upper Mustang Forbidden Kingdom Trek - Himkala Adventure");
    let shareUrl = "";
  ...
  const orgSchema = {
    ...
    "description": "Expert-guided Upper Mustang trekking packages in Nepal. Explore the Forbidden Kingdom of Lo Manthang with certified guides.",
    "address": {
      "@type": "PostalAddress",
  ...
  const trekSchema = {
    "@context": "https://schema.org",
    "@type": "Product",
    "name": "Upper Mustang Forbidden Kingdom Trek - 13 Days",
    "description": "Upper Mustang Forbidden Kingdom Trek: Explore the ancient walled city of Lo Manthang, mysterious sky caves, and preserved Tibetan Buddhist culture in Nepal's restricted Mustang region.",
    "image": imageUrl,
    "brand": {
      "@type": "Brand",
      "name": "Himkala Adventure Pvt. Ltd."
    ...
    "additionalProperty": [
      ...
      {
        "@type": "PropertyValue",
        "name": "Lo Manthang Altitude",
        "value": "3,840m"
      },
      {
        "@type": "PropertyValue",
        "name": "Lo La Pass Altitude",
        "value": "3,950m"
      },
      {
        "@type": "PropertyValue",
      ...
      },
      {
        "@type": "PropertyValue",
        "name": "Trek Type",
        "value": "Restricted Area Trek - Upper Mustang"
      },
      {
        "@type": "PropertyValue",
        "name": "Permit Cost",
        "value": "$500 for first 10 days"
      }
    ]
  };
        ...
        <section className="relative h-[45vh] min-h-[380px] md:h-[60vh] md:min-h-[500px] overflow-hidden bg-[#0f2940]">
          <div className="absolute inset-0 z-0">
            <Image
              ...
              alt="Upper Mustang Forbidden Kingdom Trek - exploring the ancient walled city of Lo Manthang and dramatic high-altitude desert landscapes in Nepal"
              fill
            ...
            <div className="max-w-5xl mx-auto text-center w-full">
              <div className="flex flex-wrap gap-2 mb-4 md:mb-6 justify-center">
                <Badge className="bg-gradient-to-r from-[#C5E0ED] to-[#9dcae0] text-[#0f2940] border-none font-bold px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm">
                  <MapPin className="w-3 h-3 mr-1" aria-hidden="true" /> Mustang Region
                </Badge>
                ...
                <Badge className="bg-purple-100 text-purple-700 border-none font-bold px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm">
                  <Castle className="w-3 h-3 mr-1" aria-hidden="true" /> Forbidden Kingdom
                </Badge>
              </div>
            ...
            <div className="lg:grid lg:grid-cols-12 lg:gap-4 lg:gap-10">
                  ...
                  <Card className="bg-gradient-to-br from-[#0f2940] to-[#1a4166] border-none rounded-xl md:rounded-2xl overflow-hidden">
                    <CardContent className="p-4 md:p-6">
                      ...
                      <a 
                        ...
                        className="block"
                        aria-label="Inquire about Upper Mustang trek on WhatsApp"
                      >
              ...
              <article className="lg:col-span-8 w-full overflow-hidden">
                ...
                <section className="mb-6 md:mb-12" id="overview">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Overview of Upper Mustang Forbidden Kingdom Trek</h2>
                  <div className="prose prose-slate max-w-none">
                    <p className="text-slate-600 leading-relaxed mb-2 md:mb-4 text-xs md:text-base">
                      The <strong>Upper Mustang Forbidden Kingdom Trek</strong> takes you to the legendary "Forbidden Kingdom," a remote and restricted region near the Tibetan border that was closed to outsiders until 1992. This unique <strong>Upper Mustang trekking</strong> adventure offers a journey through a high-altitude desert landscape of dramatic red cliffs, deep canyons, and ancient cave dwellings carved into sheer rock faces.
                    </p>
                    <p className="text-slate-600 leading-relaxed mb-2 md:mb-4 text-xs md:text-base">
                ...
                <section className="mb-6 md:mb-12" id="highlights">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Upper Mustang Forbidden Kingdom Trek Highlights</h2>
                ...
                <section className="mb-6 md:mb-12">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Best Time to Trek Upper Mustang</h2>
                ...
                <section className="mb-6 md:mb-12" id="itinerary">
                  <div className="flex items-center justify-between mb-3 md:mb-6">
                    <h2 className="text-lg md:text-2xl font-serif text-[#0f2940]">Day-by-Day Upper Mustang Itinerary</h2>
                    <Button
                      variant="outline"
                      size="sm"
                ...
                <section className="mb-6 md:mb-12" id="includes">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">What's Included in This Upper Mustang Trek</h2>
                ...
                <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-4">Important Information for Upper Mustang Trek</h2>
                ...
                <section className="mb-6 md:mb-12" id="gallery">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Photo Gallery - Upper Mustang Trek</h2>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-1 md:gap-3">
                    {gallery.map((image, i) => (
                      ...
                      >
                        <Image
                          src={image.src}
                          alt={`${image.alt} - Upper Mustang trekking experience in Nepal's Mustang region`}
                          fill
                ...
                <section className="mb-6 md:mb-12" id="faq">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Frequently Asked Questions About Upper Mustang Trek</h2>
