...
const gallery = [
  {
    ...
    alt: "Mount Manaslu at 8,163m - the eighth highest mountain in the world viewed from Samagaon on the Manaslu Circuit trek in Nepal",
    caption: "Mount Manaslu (8,163m) from Samagaon",
  },
  {
    src: "/images/used/rupinala-1.webp",
    alt: "Trail to Rupina La Pass - remote trekking route in Nepal's Ganesh Himal region with spectacular mountain views",
    caption: "Way to Rupina La",
  },
  {
    src: "/images/used/rupinala-3.webp",
    alt: "Village before Rupina La - traditional Gurung settlement on the Rupina La Pass trek in Nepal's Manaslu region",
    caption: "Village before Rupina La",
  },
  {
    src: "/images/used/rupinala-4.webp",
    alt: "Yak on the trail to Samagaon - traditional yak caravan on the Manaslu Circuit trek in Nepal",
...
export default function RupinaLaTrekPage() {
  ...
  const canonicalUrl = "https://www.himkalaadventure.com/rupina-la-pass-trek";
  const pageTitle = "Rupina La Pass Trek - Himkala Adventure";
  const pageDescription = "Rupina La Pass Trek: Cross Rupina La (4,720m) and Larkya La (5,106m) on a remote adventure through Barpak village and the Manaslu Circuit. Book now!";
  const imageUrl = "https://www.himkalaadventure.com/images/used/rupinala-4.webp";
  ...
  const orgSchema = {
    ...
    "description": "Expert-guided Rupina La Pass trekking packages in Nepal. Cross Rupina La and Larkya La passes with certified guides.",
    "address": {
      "@type": "PostalAddress",
  ...
  const trekSchema = {
    "@context": "https://schema.org",
    "@type": "Product",
    "name": "Rupina La Pass Trek - 16 Days",
    "description": "Rupina La Pass Trek: Cross Rupina La (4,720m) and Larkya La (5,106m) on a remote adventure through Barpak village and the Manaslu Circuit. A challenging double pass trek in Nepal.",
    "image": imageUrl,
    "brand": {
      "@type": "Brand",
      "name": "Himkala Adventure Pvt. Ltd."
    ...
    "additionalProperty": [
      ...
      {
        "@type": "PropertyValue",
        "name": "Larkya La Pass Altitude",
        "value": "5,106m"
      },
      {
        "@type": "PropertyValue",
        "name": "Rupina La Pass Altitude",
        "value": "4,720m"
      },
      {
        "@type": "PropertyValue",
      ...
      },
      {
        "@type": "PropertyValue",
        "name": "Trek Type",
        "value": "Remote Double Pass Trek - Teahouse + Camping"
      }
    ]
  };
      ...
      <div className="min-h-screen bg-white overflow-x-hidden">
        ...
        <section className="relative h-[45vh] min-h-[380px] md:h-[60vh] md:min-h-[500px] overflow-hidden bg-[#0f2940]">
          <div className="absolute inset-0 z-0">
            <Image
              src="/images/used/rupinala-4.webp"
              alt="Rupina La Pass Trek - remote double pass adventure crossing Rupina La (4,720m) and Larkya La (5,106m) in Nepal's Manaslu region"
              fill
            ...
            <div className="max-w-5xl mx-auto text-center w-full">
              <div className="flex flex-wrap gap-2 mb-4 md:mb-6 justify-center">
                <Badge className="bg-gradient-to-r from-[#C5E0ED] to-[#9dcae0] text-[#0f2940] border-none font-bold px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm">
                  <MapPin className="w-3 h-3 mr-1" aria-hidden="true" /> Manaslu Region
                </Badge>
                ...
                <Badge className="bg-purple-100 text-purple-700 border-none font-bold px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm">
                  <Landmark className="w-3 h-3 mr-1" aria-hidden="true" /> Remote Pass
                </Badge>
              </div>
            ...
            <div className="lg:grid lg:grid-cols-12 lg:gap-4 lg:gap-10">
                  ...
                  <Card className="bg-gradient-to-br from-[#0f2940] to-[#1a4166] border-none rounded-xl md:rounded-2xl overflow-hidden">
                    <CardContent className="p-4 md:p-6">
                      ...
                      <a 
                        ...
                        className="block"
                        aria-label="Inquire about Rupina La Pass trek on WhatsApp"
                      >
              ...
              <article className="lg:col-span-8 w-full overflow-hidden">
                ...
                <section className="mb-6 md:mb-12" id="overview">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Overview of Rupina La Pass Trek</h2>
                  <div className="prose prose-slate max-w-none">
                    <p className="text-slate-600 leading-relaxed mb-2 md:mb-4 text-xs md:text-base">
                      The <strong>Rupina La Pass Trek</strong> is a remote and adventurous trek in the lower Manaslu region, offering a true off-the-beaten-path experience for experienced trekkers seeking solitude and raw wilderness. Officially opened to tourists in 1991, this <strong>Rupina La Pass trekking</strong> route takes you through pristine landscapes, traditional Gurung villages, and across the challenging <strong>Rupina La Pass (approx. 4,720m)</strong>, before connecting to the classic Manaslu Circuit.
                    </p>
                    <p className="text-slate-600 leading-relaxed mb-2 md:mb-4 text-xs md:text-base">
                    ...
                    <p className="text-slate-600 leading-relaxed text-xs md:text-base">
                      After crossing Rupina La, you join the classic Manaslu Circuit and continue to the legendary <strong>Larkya La Pass (5,106m)</strong>, one of Nepal's longest and most spectacular high passes. This <strong>trekking in Nepal</strong> adventure is the ultimate experience for those seeking to explore the raw beauty of the Himalayas far from the crowds, combining two challenging passes, rich Gurung and Tibetan culture, and some of the most pristine wilderness in Nepal.
                    </p>
                  </div>
                </section>
                ...
                <section className="mb-6 md:mb-12" id="highlights">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Rupina La Pass Trek Highlights</h2>
                ...
                <section className="mb-6 md:mb-12">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Best Time to Trek Rupina La Pass</h2>
                ...
                <section className="mb-6 md:mb-12" id="itinerary">
                  <div className="flex items-center justify-between mb-3 md:mb-6">
                    <h2 className="text-lg md:text-2xl font-serif text-[#0f2940]">Day-by-Day Rupina La Pass Itinerary</h2>
                    <Button
                      variant="outline"
                      size="sm"
                ...
                <section className="mb-6 md:mb-12" id="includes">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">What's Included in This Rupina La Pass Trek</h2>
                ...
                <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-4">Important Information for Rupina La Pass Trek</h2>
                ...
                <section className="mb-6 md:mb-12" id="gallery">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Photo Gallery - Rupina La Pass Trek</h2>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-1 md:gap-3">
                    {gallery.map((image, i) => (
                      ...
                      >
                        <Image
                          src={image.src}
                          alt={`${image.alt} - Rupina La Pass trekking experience in Nepal's Manaslu region`}
                          fill
                ...
                <section className="mb-6 md:mb-12" id="faq">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Frequently Asked Questions About Rupina La Pass Trek</h2>
