...
const gallery = [
  {
    ...
    alt: "Ganja La Pass at 5,130m - spectacular high Himalayan pass crossing in Nepal's Langtang region with prayer flags and mountain views",
    caption: "Ganja La Pass (5,130m)",
  },
  {
    src: "/images/used/langtang-2.webp",
    alt: "Kyanjin Gompa with Langtang Lirung - ancient Buddhist monastery beneath the towering 7,227m peak in Nepal's Langtang Valley",
    caption: "Kyanjin Gompa with Langtang Lirung",
  },
  {
    src: "/images/used/langtang-1.webp",
    alt: "Langtang Valley - the Valley of Glaciers with stunning Himalayan scenery and traditional Tamang villages in Nepal",
...
export default function LangtangGanjaLaTrekPage() {
  ...
  const canonicalUrl = "https://www.himkalaadventure.com/langtang-ganja-la-trek";
  const pageTitle = "Langtang Ganja La Trek - Himkala Adventure";
  const pageDescription = "Langtang Ganja La Trek: Cross the challenging Ganja La Pass at 5,130m connecting Langtang Valley to Helambu. A technical high-altitude adventure in Nepal. Book now!";
  const imageUrl = "https://www.himkalaadventure.com/images/used/ganjala-pass-1.webp";
  ...
  const orgSchema = {
    ...
    "description": "Expert-guided Langtang Ganja La trekking packages in Nepal. Cross Ganja La Pass at 5,130m connecting Langtang Valley to Helambu with certified guides.",
    "address": {
      "@type": "PostalAddress",
  ...
  const trekSchema = {
    "@context": "https://schema.org",
    "@type": "Product",
    "name": "Langtang Ganja La Trek - 13 Days",
    "description": "Langtang Ganja La Trek: Cross the challenging Ganja La Pass at 5,130m connecting the Langtang Valley to the Helambu region. A technical high-altitude adventure with glacier crossings.",
    "image": imageUrl,
    "brand": {
      "@type": "Brand",
      "name": "Himkala Adventure Pvt. Ltd."
    ...
    "additionalProperty": [
      ...
      },
      {
        "@type": "PropertyValue",
        "name": "Pass Type",
        "value": "Technical - Requires Crampons/Ropes"
      }
    ]
  };
      ...
      <div className="min-h-screen bg-white overflow-x-hidden">
        ...
        <section className="relative h-[45vh] min-h-[380px] md:h-[60vh] md:min-h-[500px] overflow-hidden bg-[#0f2940]">
          <div className="absolute inset-0 z-0">
            <Image
              src="/images/used/ganjala-pass-1.webp"
              alt="Langtang Ganja La Trek - crossing the challenging Ganja La Pass at 5,130m in Nepal's Langtang region with spectacular Himalayan views"
              fill
            ...
            <div className="lg:grid lg:grid-cols-12 lg:gap-4 lg:gap-10">
                    ...
                    <Card className="bg-gradient-to-br from-[#0f2940] to-[#1a4166] border-none rounded-xl md:rounded-2xl overflow-hidden">
                      <CardContent className="p-4 md:p-6">
                        ...
                        <a 
                          ...
                          className="block"
                          aria-label="Inquire about Langtang Ganja La trek on WhatsApp"
                        >
              ...
              <article className="lg:col-span-8 w-full overflow-hidden mt-6 lg:mt-0">
                ...
                <section className="mb-6 md:mb-12" id="overview">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Overview of Langtang Ganja La Trek</h2>
                  <div className="prose prose-slate max-w-none">
                    <p className="text-slate-600 leading-relaxed mb-2 md:mb-4 text-xs md:text-base">
                      The <strong>Langtang Ganja La Trek</strong> is one of Nepal's most adventurous and rewarding high-altitude treks, connecting the beautiful Langtang Valley with the serene Helambu region via the challenging <strong>Ganja La Pass (5,130m)</strong>. This strenuous <strong>Langtang Ganja La trekking</strong> journey combines the best of both regions - the dramatic glaciers and yak pastures of Langtang with the cultural richness of Helambu's Sherpa and Hyolmo villages.
                    </p>
                    <p className="text-slate-600 leading-relaxed mb-2 md:mb-4 text-xs md:text-base">
                ...
                <section className="mb-6 md:mb-12" id="highlights">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Langtang Ganja La Trek Highlights</h2>
                ...
                <section className="mb-6 md:mb-12">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Best Time to Trek Langtang Ganja La</h2>
                ...
                <section className="mb-6 md:mb-12" id="itinerary">
                  <div className="flex items-center justify-between mb-3 md:mb-6">
                    <h2 className="text-lg md:text-2xl font-serif text-[#0f2940]">Day-by-Day Langtang Ganja La Itinerary</h2>
                    <Button
                      variant="outline"
                      size="sm"
                ...
                <section className="mb-6 md:mb-12" id="includes">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">What's Included in This Langtang Ganja La Trek</h2>
                ...
                <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-4">Important Information for Langtang Ganja La Trek</h2>
                ...
                <section className="mb-6 md:mb-12" id="gallery">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Photo Gallery - Langtang Ganja La Trek</h2>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-1 md:gap-3">
                    {gallery.map((image, i) => (
                      ...
                      >
                        <Image
                          src={image.src}
                          alt={`${image.alt} - Langtang Ganja La trekking experience in Nepal's Langtang region`}
                          fill
                ...
                <section className="mb-6 md:mb-12" id="faq">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Frequently Asked Questions About Langtang Ganja La Trek</h2>
