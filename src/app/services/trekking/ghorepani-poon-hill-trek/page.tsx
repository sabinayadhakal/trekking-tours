...
export default function GhorepaniPoonHillTrekPage() {
  ...
  const orgSchema = {
    ...
    "description": "Expert-guided Ghorepani Poon Hill trekking packages in Nepal. Witness the spectacular sunrise over Annapurna and Dhaulagiri from Poon Hill.",
    "address": {
      "@type": "PostalAddress",
  ...
  const trekSchema = {
    ...
    "description": "Ghorepani Poon Hill Trek: Witness the spectacular sunrise over Annapurna and Dhaulagiri from Poon Hill at 3,210m. The classic short trek in Nepal's Annapurna region with rhododendron forests and Gurung culture.",
    "image": imageUrl,
    "brand": {
      "@type": "Brand",
      "name": "Himkala Adventure Pvt. Ltd."
    ...
    "additionalProperty": [
      ...
      },
      {
        ...
        "value": "Poon Hill Sunrise, Annapurna Range, Dhaulagiri Range, Rhododendron Forests, Gurung Villages"
      }
    ]
  };
            ...
            <div className="max-w-5xl mx-auto text-center w-full">
              <div className="flex flex-wrap gap-2 mb-4 md:mb-6 justify-center">
                ...
                <Badge className="bg-amber-100 text-amber-700 border-none font-bold px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm">
                  <Sunrise className="w-3 h-3 mr-1" aria-hidden="true" /> Sunrise Views
                </Badge>
              </div>
            ...
            <div className="lg:grid lg:grid-cols-12 lg:gap-4 lg:gap-10">
                    ...
                    <Card className="bg-gradient-to-br from-[#0f2940] to-[#1a4166] border-none rounded-xl md:rounded-2xl overflow-hidden">
                      <CardContent className="p-4 md:p-6">
                        ...
                        <a 
                          ...
                          className="block"
                          aria-label="Inquire about Ghorepani Poon Hill trek on WhatsApp"
                        >
              ...
              <article className="lg:col-span-8 w-full overflow-hidden mt-6 lg:mt-0">
                ...
                <section className="mb-6 md:mb-12" id="overview">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Overview of Ghorepani Poon Hill Trek</h2>
                  <div className="prose prose-slate max-w-none">
                    <p className="text-slate-600 leading-relaxed mb-2 md:mb-4 text-xs md:text-base">
                      The <strong>Ghorepani Poon Hill Trek</strong> is the most popular short trek in Nepal, and for good reason. This classic <strong>Ghorepani Poon Hill trekking</strong> route offers an unforgettable Himalayan experience in just 4 days of <strong>trekking in Nepal</strong>, making it perfect for those with limited time or looking for a gentle introduction to the Himalayas.
                    </p>
                    <p className="text-slate-600 leading-relaxed mb-2 md:mb-4 text-xs md:text-base">
                ...
                <section className="mb-6 md:mb-12" id="highlights">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Ghorepani Poon Hill Trek Highlights</h2>
                ...
                <section className="mb-6 md:mb-12">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Best Time to Trek Ghorepani Poon Hill</h2>
                ...
                <section className="mb-6 md:mb-12" id="itinerary">
                  <div className="flex items-center justify-between mb-3 md:mb-6">
                    <h2 className="text-lg md:text-2xl font-serif text-[#0f2940]">Day-by-Day Ghorepani Poon Hill Itinerary</h2>
                    <Button
                      variant="outline"
                      size="sm"
                ...
                <section className="mb-6 md:mb-12" id="includes">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">What's Included in This Ghorepani Poon Hill Trek</h2>
                ...
                <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-4">Important Information for Ghorepani Poon Hill Trek</h2>
                ...
                <section className="mb-6 md:mb-12" id="gallery">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Photo Gallery - Ghorepani Poon Hill Trek</h2>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-1 md:gap-3">
                    {gallery.map((image, i) => (
                      ...
                      >
                        <Image
                          src={image.src}
                          alt={`${image.alt} - Ghorepani Poon Hill trekking experience in Nepal's Annapurna region`}
                          fill
                ...
                <section className="mb-6 md:mb-12" id="faq">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Frequently Asked Questions About Ghorepani Poon Hill Trek</h2>
