          ...
          <div className="max-w-5xl mx-auto text-center w-full">
            <div className="flex flex-wrap gap-2 mb-6 justify-center">
              ...
              <Badge className="bg-purple-100 text-purple-700 border-none font-bold px-4 py-2 text-sm">
                <Flower className="w-4 h-4 mr-1" /> Annapurna Sanctuary
              </Badge>
            </div>
                  ...
                  <Card className="bg-gradient-to-br from-orange-50 to-amber-50 border-orange-200/50 rounded-lg md:rounded-2xl">
                    <CardContent className="p-4 md:p-5">
                      ...
                      <p className="text-slate-600 text-xs md:text-sm leading-relaxed mb-2 md:mb-3">
                        Rhododend forests explode with color, temperatures are warm, and the sanctuary is lush 
                ...
                <div className="space-y-3 md:space-y-4">
                  {[
                    ...
                    },
                    {
                      ...
                      a: "At 4,130m, altitude is a consideration but the risk is lower than higher treks like Everest Base Camp. Our itinerary includes gradual altitude gain and an overnight at Machhapuhhre Base Camp (3,700m) before reaching ABC, allowing proper acclimatization.",
                    },
                  ].map((faq, i) => (
