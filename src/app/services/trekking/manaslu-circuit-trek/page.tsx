...
export default function ManasluCircuitTrekPage() {
  ...
  const orgSchema = {
    ...
    "description": "Expert-guided Manaslu Circuit trekking packages in Nepal. Circumnavigate Mount Manaslu and cross Larkya La Pass with certified guides.",
    "address": {
      "@type": "PostalAddress",
  ...
  const trekSchema = {
    ...
    "description": "Manaslu Circuit Trek: Circumnavigate Mount Manaslu (8,163m) and cross Larkya La Pass at 5,106m. A remote Himalayan adventure in Nepal's restricted area with Tibetan Buddhist culture.",
    "image": imageUrl,
    "brand": {
      "@type": "Brand",
      "name": "Himkala Adventure Pvt. Ltd."
            ...
            <div className="lg:grid lg:grid-cols-12 lg:gap-4 lg:gap-10">
                    ...
                    <Card className="bg-gradient-to-br from-[#0f2940] to-[#1a4166] border-none rounded-xl md:rounded-2xl overflow-hidden">
                      <CardContent className="p-4 md:p-6">
                        ...
                        <a 
                          ...
                          className="block"
                          aria-label="Inquire about Manaslu Circuit trek on WhatsApp"
                        >
              ...
              <article className="lg:col-span-8 w-full overflow-hidden mt-6 lg:mt-0">
                ...
                <section className="mb-6 md:mb-12" id="overview">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Overview of Manaslu Circuit Trek</h2>
                  <div className="prose prose-slate max-w-none">
                    <p className="text-slate-600 leading-relaxed mb-2 md:mb-4 text-xs md:text-base">
                      The <strong>Manaslu Circuit Trek</strong> is one of Nepal's most rewarding yet challenging treks, 
                      ...
                      and cultural immersion on this <strong>Manaslu Circuit trekking</strong> adventure.
                    </p>
                    <p className="text-slate-600 leading-relaxed mb-2 md:mb-4 text-xs md:text-base">
                      ...
                      rewarding <strong>trekking in Nepal</strong> experiences.
                    </p>
                    <p className="text-slate-600 leading-relaxed text-xs md:text-base">
                      The crown jewel of this trek is the crossing of <strong>Larkya La Pass (5,106m)</strong>, 
                      one of the highest and most spectacular passes in Nepal, offering breathtaking 
                      views of Manaslu, Himlung Himal, Cheo Himal, and Annapurna II.
                    </p>
                  </div>
                </section>
                ...
                <section className="mb-6 md:mb-12" id="highlights">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Manaslu Circuit Trek Highlights</h2>
                ...
                <section className="mb-6 md:mb-12">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Best Time to Trek Manaslu Circuit</h2>
                ...
                <section className="mb-6 md:mb-12" id="itinerary">
                  <div className="flex items-center justify-between mb-3 md:mb-6">
                    <h2 className="text-lg md:text-2xl font-serif text-[#0f2940]">Day-by-Day Manaslu Circuit Itinerary</h2>
                    <Button
                      variant="outline"
                      size="sm"
                ...
                <section className="mb-6 md:mb-12" id="includes">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">What's Included in This Manaslu Circuit Trek</h2>
                ...
                <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-4">Important Information for Manaslu Circuit Trek</h2>
                ...
                <section className="mb-6 md:mb-12" id="gallery">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Photo Gallery - Manaslu Circuit Trek</h2>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-1 md:gap-3">
                    {gallery.map((image, i) => (
                      ...
                      >
                        <Image
                          src={image.src}
                          alt={`${image.alt} - Manaslu Circuit trekking experience in Nepal's Manaslu region`}
                          fill
                ...
                <section className="mb-6 md:mb-12" id="faq">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Frequently Asked Questions About Manaslu Circuit Trek</h2>
