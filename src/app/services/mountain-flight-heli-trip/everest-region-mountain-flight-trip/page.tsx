          ...
          <div className="max-w-5xl mx-auto text-center w-full">
            <div className="flex flex-wrap gap-2 mb-6 justify-center">
              ...
              <Badge className="bg-purple-100 text-purple-700 border-none font-bold px-4 py-2 text-sm">
                <MountainSnow className="w-4 h-4 mr-1" /> View 8,000m Peaks
              </Badge>
            </div>
          ...
          <div className="grid lg:grid-cols-12 gap-6 md:gap-10">
            ...
            <article className="lg:col-span-8">
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg md:rounded-2xl p-4 md:p-6 flex gap-3 md:gap-4 mb-8 md:mb-12">
                ...
                <div>
                  <h4 className="font-bold text-amber-800 mb-1.5 md:mb-2 text-sm md:text-base">Important Information for Mountain Flight</h4>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg md:rounded-2xl p-4 md:p-6 mb-8 md:mb-12">
                <h4 className="font-bold text-blue-800 mb-2 flex items-center gap-2 text-sm md:text-base">
                  <Plane className="w-4 h-4 md:w-5 md:h-5" /> Mountain Flight vs. Helicopter Tour
                </h4>
                <p className="text-blue-700 text-xs md:text-sm leading-relaxed mb-2">
                  This fixed-wing mountain flight offers a different experience from helicopter tours:
                </p>
                <ul className="text-blue-700 text-xs md:text-sm leading-relaxed space-y-1 list-disc pl-4">
                ...
                <p className="text-blue-700 text-xs md:text-sm leading-relaxed mt-2">
                  If you prefer to land at Kala Patthar and step onto snow at 5,545m, please see our <Link href="/everest-region-helicopter-trip" className="font-bold underline">Everest Region Helicopter Trip</Link>.
                </p>
              </div>
