...
export default function LangtangRegionHelicopterTripPage() {
  ...
  const productSchema = {
    ...
    "description": "A 2-day helicopter adventure to the Langtang Valley with landing at Kyanjin Gompa (3,950m). Explore ancient monasteries, sample yak cheese, and witness Himalayan peaks including Langtang Lirung and Ganesh Himal.",
    "image": "https://www.himkalaadventure.com/images/used/langtang-heli.webp",
    "brand": {
      "@type": "Brand",
  ...
  const organizationSchema = {
    ...
    "name": "Himkala Adventure Pvt. Ltd.",
    "description": "Expert-guided Langtang Region helicopter trips with Kyanjin Gompa landing and Himalayan mountain views.",
    "address": {
      "@type": "PostalAddress",
          ...
          <div className="max-w-5xl mx-auto text-center w-full">
            <div className="flex flex-wrap gap-2 mb-4 md:mb-6 justify-center">
              ...
              <Badge className="bg-purple-100 text-purple-700 border-none font-bold px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm">
                <Helicopter className="w-3 h-3 mr-1" aria-hidden="true" /> Kyanjin Gompa Landing
              </Badge>
            </div>
                  ...
                  <Card className="bg-gradient-to-br from-[#0f2940] to-[#1a4166] border-none rounded-xl md:rounded-2xl overflow-hidden">
                    <CardContent className="p-4 md:p-6">
                      ...
                      <a 
                        ...
                        aria-label="Inquire about Langtang helicopter trip on WhatsApp"
                      >
            ...
            <article className="lg:col-span-8 w-full overflow-hidden mt-6 lg:mt-0">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg md:rounded-2xl p-3 md:p-6 mb-6 md:mb-12">
                <h3 className="font-bold text-blue-800 mb-2 flex items-center gap-2 text-xs md:text-base">
                  <Mountain className="w-4 h-4 md:w-5 md:h-5" aria-hidden="true" /> About the Altitude
                </h3>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-1 md:gap-3">
                  {gallery.map((image, i) => (
                    ...
                    >
                      <Image
                        src={image.src}
                        alt={`${image.alt} - Langtang Region helicopter trip in Nepal`}
                        fill
