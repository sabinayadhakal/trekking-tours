          ...
          <div className="max-w-5xl mx-auto text-center w-full">
            <div className="flex flex-wrap gap-2 mb-6 justify-center">
              ...
              <Badge className="bg-purple-100 text-purple-700 border-none font-bold px-4 py-2 text-sm">
                <Landmark className="w-4 h-4 mr-1" /> 7 UNESCO Sites
              </Badge>
            </div>
          ...
          <div className="grid lg:grid-cols-12 gap-6 md:gap-10">
              ...
              <div className="container mx-auto px-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-xl font-bold text-[#0f2940]">$795</div>
                  </div>
                  <Link href="/contact">
            ...
            <article className="lg:col-span-8">
              ...
              <section className="mb-8 md:mb-12">
                ...
                <p className="text-xs text-slate-500 mt-2">Note: Monsoon (Jun-Aug) brings lush green landscapes but occasional rain. Heritage sites are still accessible with umbrella/raincoat.</p>
              </section>
