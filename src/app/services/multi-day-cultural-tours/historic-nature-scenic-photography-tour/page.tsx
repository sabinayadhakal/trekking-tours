...
const gallery = [
  {
    ...
    caption: "Golden sunrise over the Annapurna range from Sarangkot",
  },
  {
          ...
          <div className="max-w-5xl mx-auto text-center w-full">
            <div className="flex flex-wrap gap-2 mb-6 justify-center">
              ...
              <Badge className="bg-purple-100 text-purple-700 border-none font-bold px-4 py-2 text-sm">
                <Camera className="w-4 h-4 mr-1" /> Photography Focus
              </Badge>
            </div>
          ...
          <div className="grid lg:grid-cols-12 gap-6 md:gap-10">
              ...
              <div className="container mx-auto px-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-xl font-bold text-[#0f2940]">$1,895</div>
                  </div>
                  <Link href="/contact">
                ...
                <Card className="bg-gradient-to-br from-[#0f2940] to-[#1a4166] border-none rounded-xl md:rounded-2xl overflow-hidden">
                  <CardContent className="p-4 md:p-6">
                    ...
                    <div className="space-y-2 md:space-y-3 mb-4 md:mb-6">
                      ...
                      <div className="flex items-center gap-2 md:gap-3 text-white/80 text-xs md:text-sm">
                        <Camera className="w-3 h-3 md:w-4 md:h-4 text-[#C5E0ED]" />
            ...
            <article className="lg:col-span-8">
              ...
              <section className="mb-8 md:mb-12" id="highlights">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 md:gap-3">
                  {[
                    ...
                    >
                      <Camera className="w-3 h-3 md:w-4 h-4 text-[#2d6a8a] shrink-0" />
              ...
              <section className="mb-8 md:mb-12">
                <h2 className="text-xl md:text-2xl font-serif text-[#0f2940] mb-3 md:mb-4">Best Time for Photography</h2>
                ...
                <p className="text-xs text-slate-500 mt-2">Note: Monsoon (Jun-Aug) brings lush green landscapes but limited mountain views. Still good for cultural and portrait photography in heritage sites.</p>
              </section>
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg md:rounded-2xl p-4 md:p-6 flex gap-3 md:gap-4 mb-8 md:mb-12">
                ...
                <div>
                  <h4 className="font-bold text-amber-800 mb-1.5 md:mb-2 text-sm md:text-base">Important Information for Photographers</h4>
