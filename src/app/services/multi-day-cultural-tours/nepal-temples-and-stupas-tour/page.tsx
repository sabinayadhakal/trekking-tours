...
export default function NepalTemplesAndStupasTourPage() {
  ...
  const handleShare = (platform: string) => {
    ...
    if (platform === "facebook") {
      ...
      const shareUrl = `https://twitter.com/intent/tweet?url=${url}&text=${encodeURIComponent("Nepal Temples and Stupas Tour - Sacred Pilgrimage - Himkala Adventure")}`;
    ...
    <div className="flex flex-col min-h-screen bg-[#f2ede4] overflow-x-hidden">
      <main>
            ...
            <div className="flex flex-col gap-4 md:gap-8 md:flex-row md:items-end md:justify-between">
              <div>
                <div className="flex items-center gap-2 text-[10px] sm:text-xs font-semibold tracking-[.12em] text-[#cf6943] uppercase">
                  ...
                  <span>Spiritual Pilgrimage Tour</span>
                </div>
                <h1 className="mt-3 sm:mt-5 font-serif text-[clamp(2.5rem,8vw,5rem)] leading-[1.05] sm:leading-[.95] tracking-[-.03em] sm:tracking-[-.045em] text-[#14383b]">
                  Nepal Temples <br />
                  <span className="text-[#cf6943]">and Stupas Tour</span>
                </h1>
              </div>
          ...
          <div className="mx-auto max-w-[880px]">
            <article className="prose prose-sm sm:prose-base max-w-none">
              <p className="text-[#556363] text-sm sm:text-base leading-relaxed">
                The <strong className="text-[#14383b]">Nepal Temples and Stupas Tour</strong> is a sacred 10-day 
                pilgrimage through the most revered religious sites of Nepal. From ancient Hindu temples along 
                the Bagmati River to magnificent Buddhist stupas adorned with all-seeing eyes, and from the 
                birthplace of Lord Buddha to hilltop shrines with panoramic Himalayan views, this 
                <strong className="text-[#14383b]"> Nepal spiritual tour</strong> offers a profound exploration 
                of Nepal's spiritual heritage.
              </p>
              <p className="text-[#556363] text-sm sm:text-base leading-relaxed">
                Nepal is a land where Hinduism and Buddhism have coexisted and intertwined for centuries, creating 
                a unique syncretic culture. In the Kathmandu Valley alone, you'll visit Swayambhunath with its 
                2,000-year history, the sacred Hindu temple of Pashupatinath where sadhus meditate and cremation 
                ceremonies take place, and the massive Boudhanath Stupa where Tibetan monks circumambulate daily. 
                You'll explore the temple squares of Patan and Bhaktapur, each with their own distinct architectural 
                styles and religious significance.
              </p>
              <p className="text-[#556363] text-sm sm:text-base leading-relaxed">
                The journey continues to Pokhara, where the World Peace Pagoda overlooks the serene Phewa Lake and 
                the Tal Barahi Temple sits on an island sanctuary. The spiritual climax comes in Lumbini, where 
                you'll walk in the footsteps of Buddha himself at the Mayadevi Temple and explore monasteries built 
                by Buddhist countries from around the world.
              </p>
              <p className="text-[#556363] text-sm sm:text-base leading-relaxed">
                Whether you seek spiritual enlightenment, cultural understanding, or simply the beauty of sacred 
                architecture, this <strong className="text-[#14383b]">Nepal temple and stupa pilgrimage</strong> 
                offers a deeply moving experience. Your expert guide will explain the mythology, symbolism, and 
                rituals of each site, while allowing time for personal reflection and meditation. This is more 
                than a tour—it's a spiritual journey through the heart of Nepal.
              </p>
            </article>
            ...
            <div className="mt-6 p-4 sm:p-5 bg-amber-50 border-l-4 border-amber-400 text-amber-800 text-sm rounded">
              ...
              <strong>Important:</strong> Modest dress is required at all temples and stupas. Shoulders and knees 
              must be covered. Remove shoes before entering temple premises. Photography of cremation ceremonies 
              at Pashupatinath is strictly prohibited.
            </div>
          </div>
        </section>
        ...
        <section className="bg-[#e4d8c8] px-4 sm:px-5 md:px-8 py-12 sm:py-16 lg:py-20">
          <div className="mx-auto max-w-[880px]">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-serif text-[#14383b] mb-6">Sacred Sites Highlights</h2>
        ...
        <section className="bg-[#f2ede4] px-4 sm:px-5 md:px-8 py-12 sm:py-16 lg:py-20">
          <div className="mx-auto max-w-[880px]">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-serif text-[#14383b] mb-6">Best Time to Visit Nepal's Sacred Sites</h2>
            ...
            <p className="mt-3 text-[10px] text-[#66706d]">Note: Monsoon (Jun-Aug) brings lush green landscapes but occasional rain. Temple visits are still possible with umbrella/raincoat. Lumbini remains accessible.</p>
          </div>
        </section>
        ...
        <section className="bg-[#e4d8c8] px-4 sm:px-5 md:px-8 py-12 sm:py-16 lg:py-20">
          <div className="mx-auto max-w-[880px]">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-serif text-[#14383b]">Day-by-Day Pilgrimage Itinerary</h2>
              <button
        ...
        <section className="bg-[#e4d8c8] px-4 sm:px-5 md:px-8 py-12 sm:py-16 lg:py-20" id="gallery">
          <div className="mx-auto max-w-[880px]">
            ...
            <p className="text-[#556363] text-sm sm:text-base mb-6">
              A visual pilgrimage through Nepal's sacred temples, stupas, and spiritual sites.
            </p>
        ...
        <section className="bg-[#e4d8c8] px-4 sm:px-5 md:px-8 py-12 sm:py-16 lg:py-20">
          <div className="mx-auto max-w-[880px] text-center">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-serif text-[#14383b] mb-3">Ready for Your Sacred Pilgrimage?</h2>
            <p className="text-[#556363] text-sm sm:text-base mb-6 max-w-2xl mx-auto">
              Book your Nepal Temples and Stupas Tour today and embark on a spiritual journey through the sacred heart of the Himalayas.
            </p>
