...
export default function BhaktapurPatanSightseeingPage() {
  ...
  const handleShare = (platform: string) => {
    ...
    const title = encodeURIComponent("Bhaktapur & Patan Sightseeing Tour - Himkala Adventure");
    let shareUrl = "";
  ...
  const productSchema = {
    ...
    "@type": "Product",
    "name": "Bhaktapur & Patan Sightseeing Tour",
    "description": "A full-day heritage tour exploring two of Nepal's ancient royal cities - Bhaktapur and Patan. Visit UNESCO World Heritage Sites, ancient temples, and experience Newari culture with an expert guide.",
    "image": "https://www.himkalaadventure.com/images/used/bhaktapur-patan-nepal.webp",
    "brand": {
      "@type": "Brand",
    ...
    "offers": {
      ...
      "url": "https://www.himkalaadventure.com/services/day-sightseeings/bhaktapur-patan-sightseeing"
    },
    "aggregateRating": {
  ...
  const organizationSchema = {
    ...
    "name": "Himkala Adventure Pvt. Ltd.",
    "description": "Expert-guided day sightseeing tours in Nepal including Bhaktapur and Patan heritage tours.",
    "address": {
      "@type": "PostalAddress",
          ...
          <div className="max-w-5xl mx-auto text-center w-full">
            <div className="flex flex-wrap gap-2 mb-4 md:mb-6 justify-center">
              ...
              <Badge className="bg-purple-100 text-purple-700 border-none font-bold px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm">
                <Landmark className="w-3 h-3 mr-1" aria-hidden="true" /> 2 UNESCO Sites
              </Badge>
            </div>
                  ...
                  <Card className="bg-gradient-to-br from-[#0f2940] to-[#1a4166] border-none rounded-xl md:rounded-2xl overflow-hidden">
                    <CardContent className="p-4 md:p-6">
                      ...
                      <a 
                        ...
                        aria-label="Inquire about Bhaktapur and Patan sightseeing tour on WhatsApp"
                      >
                    ...
                    <CardContent className="p-4 md:p-6">
                      ...
                      <div className="space-y-2 text-[10px] md:text-sm">
                        ...
                        <div className="flex justify-between py-1.5 md:py-2 border-b border-slate-100">
                          ...
                          <span className="font-medium text-[#0f2940]">~6:00 PM</span>
                        </div>
                        <div className="flex justify-between py-1.5 md:py-2 border-b border-slate-100">
                        ...
                        <div className="flex justify-between py-1.5 md:py-2 border-b border-slate-100">
                          ...
                          <span className="font-medium text-[#0f2940]">Cultural, Heritage</span>
                        </div>
                        <div className="flex justify-between py-1.5 md:py-2 border-b border-slate-100">
                          <span className="text-slate-500">UNESCO Sites</span>
                          <span className="font-medium text-[#0f2940]">Bhaktapur Durbar Square, Patan Durbar Square</span>
                        </div>
            ...
            <article className="lg:col-span-8 w-full overflow-hidden mt-6 lg:mt-0">
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg md:rounded-2xl p-3 md:p-6 mb-6 md:mb-12">
                <h3 className="font-bold text-amber-800 mb-2 flex items-center gap-2 text-xs md:text-base">
                  <Landmark className="w-4 h-4 md:w-5 md:h-5" aria-hidden="true" /> Exploring Bhaktapur Durbar Square
                </h3>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg md:rounded-2xl p-3 md:p-6 mb-6 md:mb-12">
                <h3 className="font-bold text-blue-800 mb-2 flex items-center gap-2 text-xs md:text-base">
                  <Palette className="w-4 h-4 md:w-5 md:h-5" aria-hidden="true" /> Exploring Patan Durbar Square
                </h3>
                <div className="grid md:grid-cols-2 gap-3">
                  <div>
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg md:rounded-2xl p-3 md:p-6 flex gap-2 md:gap-4 mb-6 md:mb-12">
                ...
                <div>
                  ...
                  <ul className="text-amber-700 text-[10px] md:text-sm leading-relaxed space-y-1 md:space-y-2">
                    ...
                    <li>• <strong>Cancellation Policy:</strong> Free cancellation up to 24 hours before the tour. Within 24 hours, 50% cancellation fee applies.</li>
                  </ul>
                </div>
              </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-1 md:gap-3">
                  {gallery.map((image, i) => (
                    ...
                    >
                      <Image
                        src={image.src}
                        alt={`${image.alt} - Bhaktapur and Patan sightseeing tour in Nepal`}
                        fill
