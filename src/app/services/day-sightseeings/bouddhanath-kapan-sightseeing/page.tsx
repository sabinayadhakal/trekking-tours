          ...
          <div className="grid lg:grid-cols-12 gap-6 md:gap-10">
            ...
            <article className="lg:col-span-8">
              ...
              <section className="mb-8 md:mb-12">
                ...
                <p className="text-xs text-slate-500 mt-2">Note: The tour operates year-round. Monsoon (Jun-Aug) brings occasional rain, but both sites are still accessible with umbrella/raincoat.</p>
              </section>
                      ...
                      <CardContent className="p-0">
                        ...
                        >
                          <div className="w-12 h-12 md:w-14 md:h-14 bg-gradient-to-br from-[#C5E0ED] to-[#9dcae0] rounded-lg md:rounded-xl flex flex-col items-center justify-center shrink-0">
                            <span className="text-[10px] font-bold text-[#0f2940] uppercase">Half Day</span>
                          </div>
                ...
                <CardContent className="p-4 md:p-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-4">
                    <div className="bg-slate-50 p-2 rounded">
                      <div className="font-bold text-xs text-[#0f2940]">Stupa</div>
                      <div className="text-xs text-slate-600">Buddhist reliquary mound</div>
                    </div>
                    <div className="bg-slate-50 p-2 rounded">
                      <div className="font-bold text-xs text-[#0f2940]">Mani</div>
                      <div className="text-xs text-slate-600">Prayer wheel / mantra</div>
                    </div>
                    <div className="bg-slate-50 p-2 rounded">
                      <div className="font-bold text-xs text-[#0f2940]">Gompa</div>
                      <div className="text-xs text-slate-600">Buddhist monastery</div>
                    </div>
                    <div className="bg-slate-50 p-2 rounded">
                      <div className="font-bold text-xs text-[#0f2940]">Khata</div>
                      <div className="text-xs text-slate-600">Ceremonial scarf</div>
                    </div>
                    <div className="bg-slate-50 p-2 rounded">
                      <div className="font-bold text-xs text-[#0f2940]">Rinpoche</div>
                      <div className="text-xs text-slate-600">Precious teacher</div>
                    </div>
                    <div className="bg-slate-50 p-2 rounded">
                      <div className="font-bold text-xs text-[#0f2940]">Mantra</div>
                      <div className="text-xs text-slate-600">Sacred utterance</div>
                    </div>
                    <div className="bg-slate-50 p-2 rounded">
                      <div className="font-bold text-xs text-[#0f2940]">Mandala</div>
                      <div className="text-xs text-slate-600">Cosmic diagram</div>
                    </div>
                    <div className="bg-slate-50 p-2 rounded">
                      <div className="font-bold text-xs text-[#0f2940]">Bodhisattva</div>
                      <div className="text-xs text-slate-600">Enlightened being</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
