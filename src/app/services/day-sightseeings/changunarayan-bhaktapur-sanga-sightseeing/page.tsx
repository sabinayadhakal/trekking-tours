...
export default function ChangunarayanBhaktapurSangaSightseeingPage() {
  ...
  const productSchema = {
    ...
    "@type": "Product",
    "name": "Changunarayan, Bhaktapur & Sanga Sightseeing Tour",
    "description": "A full-day heritage and scenic tour visiting Changunarayan Temple (Nepal's oldest temple, 4th century), Bhaktapur Durbar Square (UNESCO World Heritage Site), and Sanga hilltop viewpoint with panoramic Himalayan views.",
    "image": "https://www.himkalaadventure.com/images/used/changunarayan-1.webp",
    "brand": {
      "@type": "Brand",
    ...
    "offers": {
      ...
      "url": "https://www.himkalaadventure.com/services/day-sightseeings/changunarayan-bhaktapur-sanga-sightseeing"
    },
    "aggregateRating": {
  ...
  const organizationSchema = {
    ...
    "name": "Himkala Adventure Pvt. Ltd.",
    "description": "Expert-guided day sightseeing tours in Nepal including Changunarayan, Bhaktapur, and Sanga heritage and scenic tours.",
    "address": {
      "@type": "PostalAddress",
                  ...
                  <Card className="bg-gradient-to-br from-[#0f2940] to-[#1a4166] border-none rounded-xl md:rounded-2xl overflow-hidden">
                    <CardContent className="p-4 md:p-6">
                      ...
                      <a 
                        ...
                        aria-label="Inquire about Changunarayan, Bhaktapur and Sanga sightseeing tour on WhatsApp"
                      >
            ...
            <article className="lg:col-span-8 w-full overflow-hidden mt-6 lg:mt-0">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg md:rounded-2xl p-3 md:p-6 mb-6 md:mb-12">
                <h3 className="font-bold text-blue-800 mb-2 flex items-center gap-2 text-xs md:text-base">
                  <Landmark className="w-4 h-4 md:w-5 md:h-5" aria-hidden="true" /> Bhaktapur - The Medieval City
                </h3>
                <div className="grid md:grid-cols-2 gap-3">
                  <div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg md:rounded-2xl p-3 md:p-6 mb-6 md:mb-12">
                <h3 className="font-bold text-green-800 mb-2 flex items-center gap-2 text-xs md:text-base">
                  <Eye className="w-4 h-4 md:w-5 md:h-5" aria-hidden="true" /> Sanga Viewpoint - Himalayan Panorama
                </h3>
                <div className="grid md:grid-cols-2 gap-3">
                  <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-1 md:gap-3">
                  {gallery.map((image, i) => (
                    ...
                    >
                      <Image
                        src={image.src}
                        alt={`${image.alt} - Changunarayan, Bhaktapur and Sanga sightseeing tour in Nepal`}
                        fill
              ...
              <Card className="bg-white border-[#C5E0ED]/30 rounded-lg md:rounded-xl mb-6 md:mb-12">
                <CardContent className="p-3 md:p-6">
                  <h3 className="font-bold text-[#0f2940] mb-2 md:mb-4 flex items-center gap-2 text-xs md:text-base">
                    <History className="w-4 h-4 md:w-5 md:h-5 text-[#2d6a8a]" aria-hidden="true" /> Heritage Timeline
                  </h3>
