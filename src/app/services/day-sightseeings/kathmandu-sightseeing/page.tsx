  ...
  const schemaData = {
    ...
    "additionalProperty": [
      ...
      },
      {
        "@type": "PropertyValue",
        "name": "UNESCO Sites",
        "value": "Swayambhunath, Kathmandu Durbar Square, Pashupatinath, Boudhanath"
      }
    ]
  };
          ...
          <div className="container mx-auto px-3 md:px-6 max-w-full">
            ...
            <div className="lg:grid lg:grid-cols-12 lg:gap-4 lg:gap-10">
              ...
              <article className="lg:col-span-8 w-full overflow-hidden mt-6 lg:mt-0">
                ...
                <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-4">Detailed Site Descriptions</h2>
                ...
                <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-4">Important Information for Your Visit</h2>
                ...
                <Card className="bg-white border-[#C5E0ED]/30 rounded-lg md:rounded-xl mb-6 md:mb-12">
                  <CardContent className="p-3 md:p-6">
                    <h2 className="font-bold text-[#0f2940] mb-2 md:mb-4 flex items-center gap-2 text-xs md:text-base">
