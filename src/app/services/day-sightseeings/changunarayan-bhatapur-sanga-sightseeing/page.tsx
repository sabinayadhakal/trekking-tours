          ...
          <div className="grid lg:grid-cols-12 gap-6 md:gap-10">
            ...
            <article className="lg:col-span-8">
              ...
              <section className="mb-8 md:mb-12">
                ...
                <p className="text-xs text-slate-500 mt-2">Note: The tour operates year-round. Monsoon (Jun-Aug) brings occasional rain but landscapes are lush and green. Umbrella/raincoat recommended.</p>
              </section>
                ...
                <CardContent className="p-4 md:p-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex gap-3">
                      <div className="w-16 text-xs font-bold text-[#2d6a8a]">4th C.</div>
                      <div className="text-xs text-slate-600">Changunarayan Temple established by King Mandev of Licchavi dynasty</div>
                    </div>
                    <div className="flex gap-3">
                      <div className="w-16 text-xs font-bold text-[#2d6a8a]">12th C.</div>
                      <div className="text-xs text-slate-600">Bhaktapur founded as capital of the Malla kingdom</div>
                    </div>
                    <div className="flex gap-3">
                      <div className="w-16 text-xs font-bold text-[#2d6a8a]">1702</div>
                      <div className="text-xs text-slate-600">Nyatapola Temple built - Nepal's tallest pagoda</div>
                    </div>
                    <div className="flex gap-3">
                      <div className="w-16 text-xs font-bold text-[#2d6a8a">1750s</div>
                      <div className="text-xs text-slate-600">Palace of 55 Windows completed</div>
                    </div>
                    <div className="flex gap-3">
                      <div className="w-16 text-xs font-bold text-[#2d6a8a">1979</div>
                      <div className="text-xs text-slate-600">Bhaktapur Durbar Square designated UNESCO World Heritage Site</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
