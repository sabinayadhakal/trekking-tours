...
export default function BungamatiKhokanaPatanSightseeingPage() {
  ...
  const productSchema = {
    ...
    "@type": "Product",
    "name": "Bungamati, Khokana & Patan Sightseeing Tour",
    "description": "A full-day cultural tour exploring authentic Newari villages of Bungamati and Khokana, plus the UNESCO World Heritage site of Patan Durbar Square in Nepal.",
    "image": "https://www.himkalaadventure.com/images/used/bungamati-1.webp",
    "brand": {
      "@type": "Brand",
    ...
    "offers": {
      ...
      "url": "https://www.himkalaadventure.com/services/day-sightseeings/bungamati-khokana-patan-sightseeing"
    },
    "aggregateRating": {
  ...
  const organizationSchema = {
    ...
    "name": "Himkala Adventure Pvt. Ltd.",
    "description": "Expert-guided day sightseeing tours in Nepal including Bungamati, Khokana, and Patan cultural tours.",
    "address": {
      "@type": "PostalAddress",
          ...
          <div className="max-w-5xl mx-auto text-center w-full">
            <div className="flex flex-wrap gap-2 mb-4 md:mb-6 justify-center">
              ...
              <Badge className="bg-purple-100 text-purple-700 border-none font-bold px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm">
                <Home className="w-3 h-3 mr-1" aria-hidden="true" /> Village Experience
              </Badge>
            </div>
                  ...
                  <Card className="bg-gradient-to-br from-[#0f2940] to-[#1a4166] border-none rounded-xl md:rounded-2xl overflow-hidden">
                    <CardContent className="p-4 md:p-6">
                      ...
                      <div className="space-y-2 md:space-y-3 mb-4 md:mb-6">
                        ...
                        <div className="flex items-center gap-2 md:gap-3 text-white/80 text-[10px] md:text-sm">
                          <Home className="w-3 h-3 md:w-4 md:h-4 text-[#C5E0ED]" aria-hidden="true" />
                      ...
                      <a 
                        ...
                        aria-label="Inquire about Bungamati, Khokana and Patan sightseeing tour on WhatsApp"
                      >
            ...
            <article className="lg:col-span-8 w-full overflow-hidden mt-6 lg:mt-0">
              ...
              <section className="mb-6 md:mb-12" id="highlights">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 md:gap-3">
                  {[
                    ...
                    >
                      <Home className="w-3 h-3 md:w-4 h-4 text-[#2d6a8a] shrink-0" aria-hidden="true" />
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg md:rounded-2xl p-3 md:p-6 mb-6 md:mb-12">
                <h3 className="font-bold text-green-800 mb-2 flex items-center gap-2 text-xs md:text-base">
                  <Droplet className="w-4 h-4 md:w-5 md:h-5" aria-hidden="true" /> Khokana - The Mustard Oil Village
                </h3>
                <div className="grid md:grid-cols-2 gap-3">
                  <div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg md:rounded-2xl p-3 md:p-6 mb-6 md:mb-12">
                <h3 className="font-bold text-blue-800 mb-2 flex items-center gap-2 text-xs md:text-base">
                  <Landmark className="w-4 h-4 md:w-5 md:h-5" aria-hidden="true" /> Patan - City of Fine Arts
                </h3>
                <div className="grid md:grid-cols-2 gap-3">
                  <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-1 md:gap-3">
                  {gallery.map((image, i) => (
                    ...
                    >
                      <Image
                        src={image.src}
                        alt={`${image.alt} - Bungamati, Khokana and Patan sightseeing tour in Nepal`}
                        fill
              ...
              <Card className="bg-white border-[#C5E0ED]/30 rounded-lg md:rounded-xl mb-6 md:mb-12">
                <CardContent className="p-3 md:p-6">
                  <h3 className="font-bold text-[#0f2940] mb-2 md:mb-4 flex items-center gap-2 text-xs md:text-base">
                    <Scroll className="w-4 h-4 md:w-5 md:h-5 text-[#2d6a8a]" aria-hidden="true" /> Newari Culture Glossary
                  </h3>
