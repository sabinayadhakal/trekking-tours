          ...
          <div className="max-w-5xl mx-auto text-center w-full">
            <div className="flex flex-wrap gap-2 mb-6 justify-center">
              ...
              <Badge className="bg-purple-100 text-purple-700 border-none font-bold px-4 py-2 text-sm">
                <Home className="w-4 h-4 mr-1" /> Village Experience
              </Badge>
            </div>
          ...
          <div className="grid lg:grid-cols-12 gap-6 md:gap-10">
              ...
              <div className="container mx-auto px-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-xl font-bold text-[#0f2940]">$75</div>
                  </div>
                  <Link href="/contact">
            ...
            <article className="lg:col-span-8">
              ...
              <section className="mb-8 md:mb-12">
                ...
                <p className="text-xs text-slate-500 mt-2">Note: The tour operates year-round. Monsoon (Jun-Aug) brings occasional rain but villages are lush and green. Umbrella/raincoat recommended.</p>
              </section>
                ...
                <CardContent className="p-4 md:p-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-4">
                    <div className="bg-slate-50 p-2 rounded">
                      <div className="font-bold text-xs text-[#0f2940]">Newar</div>
                      <div className="text-xs text-slate-600">Indigenous people of Kathmandu Valley</div>
                    </div>
                    <div className="bg-slate-50 p-2 rounded">
                      <div className="font-bold text-xs text-[#0f2940]">Machhindranath</div>
                      <div className="text-xs text-slate-600">Rain god, patron deity of Patan</div>
                    </div>
                    <div className="bg-slate-50 p-2 rounded">
                      <div className="font-bold text-xs text-[#0f2940]">Kol</div>
                      <div className="text-xs text-slate-600">Traditional oil press</div>
                    </div>
                    <div className="bg-slate-50 p-2 rounded">
                      <div className="font-bold text-xs text-[#0f2940]">Bahal</div>
                      <div className="text-xs text-slate-600">Buddhist monastery courtyard</div>
                    </div>
                    <div className="bg-slate-50 p-2 rounded">
                      <div className="font-bold text-xs text-[#0f2940]">Puja</div>
                      <div className="text-xs text-slate-600">Worship ritual</div>
                    </div>
                    <div className="bg-slate-50 p-2 rounded">
                      <div className="font-bold text-xs text-[#0f2940]">Chaitya</div>
                      <div className="text-xs text-slate-600">Small Buddhist shrine</div>
                    </div>
                    <div className="bg-slate-50 p-2 rounded">
                      <div className="font-bold text-xs text-[#0f2940]">Lohan</div>
                      <div className="text-xs text-slate-600">Carved stone water spout</div>
                    </div>
                    <div className="bg-slate-50 p-2 rounded">
                      <div className="font-bold text-xs text-[#0f2940]">Patan</div>
                      <div className="text-xs text-slate-600">Lalitpur, City of Fine Arts</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
