...
export default function KathmanduSightseeingPage() {
  ...
  const productSchema = {
    ...
    "@type": "Product",
    "name": "Kathmandu Valley Sightseeing Tour",
    "description": "A comprehensive full-day tour exploring four UNESCO World Heritage Sites in Kathmandu Valley: Swayambhunath Stupa, Kathmandu Durbar Square, Pashupatinath Temple, and Boudhanath Stupa.",
    "image": "https://www.himkalaadventure.com/images/used/monkey_temple.webp",
    "brand": {
      "@type": "Brand",
    ...
    "offers": {
      ...
      "url": "https://www.himkalaadventure.com/services/day-sightseeings/kathmandu-sightseeing"
    },
    "aggregateRating": {
  ...
  const organizationSchema = {
    ...
    "name": "Himkala Adventure Pvt. Ltd.",
    "description": "Expert-guided day sightseeing tours in Nepal including comprehensive Kathmandu Valley UNESCO heritage tours.",
    "address": {
      "@type": "PostalAddress",
    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <section className="relative h-[45vh] min-h-[380px] md:h-[60vh] md:min-h-[500px] overflow-hidden bg-[#0f2940]">
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/used/monkey_temple.webp"
            alt="Swayambhunath Stupa (Monkey Temple) in Kathmandu, Nepal - iconic UNESCO World Heritage site with all-seeing eyes of Buddha"
            fill
          ...
          <div className="max-w-5xl mx-auto text-center w-full">
            <div className="flex flex-wrap gap-2 mb-4 md:mb-6 justify-center">
              ...
              <Badge className="bg-purple-100 text-purple-700 border-none font-bold px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm">
                <Landmark className="w-3 h-3 mr-1" aria-hidden="true" /> 4 UNESCO Sites
              </Badge>
            </div>
                  ...
                  <Card className="bg-gradient-to-br from-[#0f2940] to-[#1a4166] border-none rounded-xl md:rounded-2xl overflow-hidden">
                    <CardContent className="p-4 md:p-6">
                      ...
                      <a 
                        ...
                        aria-label="Inquire about Kathmandu Valley sightseeing tour on WhatsApp"
                      >
            ...
            <article className="lg:col-span-8 w-full overflow-hidden mt-6 lg:mt-0">
              ...
              <section className="mb-6 md:mb-12" id="highlights">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 md:gap-3">
                  {[
                    ...
                    >
                      <Landmark className="w-3 h-3 md:w-4 h-4 text-[#2d6a8a] shrink-0" aria-hidden="true" />
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg md:rounded-2xl p-3 md:p-6 mb-6 md:mb-12">
                <h3 className="font-bold text-green-800 mb-2 flex items-center gap-2 text-xs md:text-base">
                  <Droplet className="w-4 h-4 md:w-5 md:h-5" aria-hidden="true" /> Pashupatinath Temple - Sacred Hindu Shrine
                </h3>
                <div className="grid md:grid-cols-2 gap-3">
                  <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-1 md:gap-3">
                  {gallery.map((image, i) => (
                    ...
                    >
                      <Image
                        src={image.src}
                        alt={`${image.alt} - Kathmandu Valley sightseeing tour in Nepal`}
                        fill
              ...
              <Card className="bg-white border-[#C5E0ED]/30 rounded-lg md:rounded-xl mb-6 md:mb-12">
                <CardContent className="p-3 md:p-6">
                  <h3 className="font-bold text-[#0f2940] mb-2 md:mb-4 flex items-center gap-2 text-xs md:text-base">
                    <History className="w-4 h-4 md:w-5 md:h-5 text-[#2d6a8a]" aria-hidden="true" /> UNESCO World Heritage Timeline
                  </h3>
