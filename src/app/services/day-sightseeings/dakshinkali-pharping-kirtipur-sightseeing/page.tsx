...
const gallery = [
  ...
  },
  {
    ...
    alt: "Meditation Cave",
    caption: "Sacred meditation cave where Guru Rinpoche practiced",
  },
  {
    src: "https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=2071&auto=format&fit=crop",
    alt: "Kirtipur Temple",
    caption: "Ancient temple in Kirtipur with traditional Newari architecture",
  },
  {
    src: "https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=2071&auto=format&fit=crop",
    alt: "Pharping Village",
    caption: "Traditional Newari village of Pharping",
  },
];
          ...
          <div className="grid lg:grid-cols-12 gap-6 md:gap-10">
              ...
              <div className="container mx-auto px-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-xl font-bold text-[#0f2940]">$65</div>
                  </div>
                  <Link href="/contact">
            ...
            <article className="lg:col-span-8">
              ...
              <section className="mb-8 md:mb-12">
                ...
                <p className="text-xs text-slate-500 mt-2">Note: The tour operates year-round. For the full Dakshinkali experience with animal sacrifices, plan your visit on a Tuesday or Saturday.</p>
              </section>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg md:rounded-2xl p-4 md:p-6 mb-8 md:mb-12">
                <h4 className="font-bold text-blue-800 mb-3 flex items-center gap-2 text-sm md:text-base">
                  <Landmark className="w-4 h-4 md:w-5 md:h-5" /> Kirtipur - Hilltop Historic Town
                </h4>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
              ...
              <Card className="bg-white border-[#C5E0ED]/30 rounded-lg md:rounded-xl mb-8 md:mb-12">
                <CardContent className="p-4 md:p-6">
                  <h3 className="font-bold text-[#0f2940] mb-3 md:mb-4 flex items-center gap-2 text-sm md:text-base">
                    <History className="w-4 h-4 md:w-5 md:h-5 text-[#2d6a8a]" /> Spiritual Heritage Timeline
                  </h3>
                  <div className="space-y-3">
                    <div className="flex gap-3">
                      <div className="w-20 text-xs font-bold text-[#2d6a8a]">8th Century</div>
                      <div className="text-xs text-slate-600">Guru Rinpoche meditates in Pharping caves and achieves enlightenment</div>
                    </div>
                    <div className="flex gap-3">
                      <div className="w-20 text-xs font-bold text-[#2d6a8a]">12th Century</div>
                      <div className="text-xs text-slate-600">Kirtipur established as an independent Newari kingdom</div>
                    </div>
                    <div className="flex gap-3">
                      <div className="w-20 text-xs font-bold text-[#2d6a8a]">17th Century</div>
                      <div className="text-xs text-slate-600">Dakshinkali Temple becomes major pilgrimage site</div>
                    </div>
                    <div className="flex gap-3">
                      <div className="w-20 text-xs font-bold text-[#2d6a8a]">1767</div>
                      <div className="text-xs text-slate-600">Kirtipur conquered by Prithvi Narayan Shah during unification</div>
                    </div>
                    <div className="flex gap-3">
                      <div className="w-20 text-xs font-bold text-[#2d6a8a">1970s</div>
                      <div className="text-xs text-slate-600">Tibetan monasteries established in Pharping by exiled lamas</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
