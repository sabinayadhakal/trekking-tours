...
const gallery = [
  {
    ...
    alt: "Druk Path Trek - alpine mountain landscape with pristine lakes and Himalayan views in Bhutan",
    caption: "Druk Path Trek",
  },
  {
    src: "/images/used/bhutan-culture.webp",
    alt: "Thimphu Valley view from Sangaygang - panoramic city and mountain views in Bhutan's capital",
    caption: "Thimphu from above. 🏔️✨ Sangaygang views.",
  },
  {
    src: "/images/used/wangchuk-bhutan.webp",
    alt: "Wangdicholing Palace - historic royal residence where the Wangchuck dynasty began in Bhutan",
...
export default function DrukPathTrekPage() {
  ...
  const canonicalUrl = "https://www.himkalaadventure.com/destinations/bhutan/druk-path-trek";
  const pageTitle = "Druk Path Trek - Himkala Adventure";
  const pageDescription = "Druk Path Trek: Bhutan's classic 6-day camping trek connecting Paro and Thimphu through alpine lakes and Himalayan views. Mount Chomolhari and pristine wilderness. Book now!";
  const imageUrl = "https://www.himkalaadventure.com/images/used/bhutan-druk.webp";
  ...
  const orgSchema = {
    ...
    "description": "Expert-guided Druk Path trekking packages in Bhutan. Classic camping trek connecting Paro and Thimphu with alpine lakes and Himalayan views.",
    "address": {
      "@type": "PostalAddress",
  ...
  const trekSchema = {
    ...
    "additionalProperty": [
      ...
      },
      {
        "@type": "PropertyValue",
        "name": "Highlights",
        "value": "Mount Chomolhari views, Simkotra Tsho Lake, Jele Dzong, Phajoding Monastery"
      }
    ]
  };
      ...
      <div className="min-h-screen bg-white overflow-x-hidden">
        ...
        <section className="relative h-[45vh] min-h-[380px] md:h-[60vh] md:min-h-[500px] overflow-hidden bg-[#0f2940]">
          <div className="absolute inset-0 z-0">
            <Image
              src="/images/used/bhutan-druk.webp"
              alt="Druk Path Trek - classic Himalayan camping trek in Bhutan with alpine lakes and panoramic mountain views"
              fill
            ...
            <div className="max-w-5xl mx-auto text-center w-full">
              <div className="flex flex-wrap gap-2 mb-4 md:mb-6 justify-center">
                ...
                <Badge className="bg-orange-100 text-orange-700 border-none font-bold px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm">
                  <Mountain className="w-3 h-3 mr-1" aria-hidden="true" /> Moderate Trek
                </Badge>
                <Badge className="bg-blue-100 text-blue-700 border-none font-bold px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm">
                  <Tent className="w-3 h-3 mr-1" aria-hidden="true" /> Camping Trek
                </Badge>
              </div>
            ...
            <div className="lg:grid lg:grid-cols-12 lg:gap-4 lg:gap-10">
                  ...
                  <Card className="bg-gradient-to-br from-[#0f2940] to-[#1a4166] border-none rounded-xl md:rounded-2xl overflow-hidden">
                    <CardContent className="p-4 md:p-6">
                      ...
                      <a 
                        ...
                        className="block"
                        aria-label="Inquire about Druk Path trek on WhatsApp"
                      >
              ...
              <article className="lg:col-span-8 w-full overflow-hidden">
                ...
                <section className="mb-6 md:mb-12" id="overview">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Overview of Druk Path Trek</h2>
                  <div className="prose prose-slate max-w-none">
                    ...
                    <p className="text-slate-600 leading-relaxed text-xs md:text-base">
                      This <strong>Druk Path trekking</strong> adventure is perfect for those seeking a genuine Himalayan 
                      trekking experience without the extreme altitude or duration of longer expeditions. With full 
                      camping support, expert guides, and all meals included, the Druk Path offers an unforgettable 
                      adventure through the pristine wilderness of the Land of the Thunder Dragon.
                    </p>
                  </div>
                </section>
                ...
                <section className="mb-6 md:mb-12" id="highlights">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Druk Path Trek Highlights</h2>
                ...
                <section className="mb-6 md:mb-12">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Best Time to Trek Druk Path</h2>
                ...
                <section className="mb-6 md:mb-12" id="itinerary">
                  <div className="flex items-center justify-between mb-3 md:mb-6">
                    <h2 className="text-lg md:text-2xl font-serif text-[#0f2940]">Day-by-Day Druk Path Itinerary</h2>
                    <Button
                      variant="outline"
                      size="sm"
                ...
                <section className="mb-6 md:mb-12" id="includes">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">What's Included in This Druk Path Trek</h2>
                ...
                <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-4">Important Information for Druk Path Trek</h2>
                ...
                <section className="mb-6 md:mb-12" id="gallery">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Photo Gallery - Druk Path Trek</h2>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-1 md:gap-3">
                    {gallery.map((image, i) => (
                      ...
                      >
                        <Image
                          src={image.src}
                          alt={`${image.alt} - Druk Path trekking experience in Bhutan`}
                          fill
                ...
                <section className="mb-6 md:mb-12" id="faq">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Frequently Asked Questions About Druk Path Trek</h2>
