...
const gallery = [
  ...
  },
  {
    src: "https://images.unsplash.com/photo-1625401878753-0b2d4d99790a?q=80&w=2070&auto=format&fit=crop",
    alt: "Thongdrel",
    caption: "Giant Thongdrel (Religious Scroll) Unveiling",
  },
  {
    src: "https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=2071&auto=format&fit=crop",
    alt: "Dochula Pass",
    caption: "Dochula Pass with Prayer Flags",
  },
  {
    src: "https://images.unsplash.com/photo-1612611345910-17b9560f6e93?q=80&w=2070&auto=format&fit=crop",
    alt: "Festival Crowd",
    caption: "Bhutanese Gathering at Tshechu",
  },
  {
    src: "https://images.unsplash.com/photo-1625401878753-0b2d4d99790a?q=80&w=2070&auto=format&fit=crop",
    alt: "Taktsang Monastery",
    caption: "Taktsang - Tiger's Nest Monastery",
  },
  {
    src: "https://images.unsplash.com/photo-1625401916060-e734a3c4d42a?q=80&w=2070&auto=format&fit=crop",
    alt: "Traditional Music",
    caption: "Traditional Bhutanese Musicians",
  },
];
          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-4 lg:gap-10">
            ...
            <aside className="hidden lg:block lg:col-span-4">
              <div className="sticky top-24 space-y-4 md:space-y-6">
                ...
                <Card className="bg-[#f8fbfc] border-[#C5E0ED]/30 rounded-xl md:rounded-2xl overflow-hidden">
                  <CardContent className="p-4 md:p-6">
                    <h3 className="font-bold text-[#0f2940] mb-3 md:mb-4 flex items-center gap-2 text-sm md:text-base">
                      <Calendar className="w-3 h-3 md:w-4 md:h-4 text-[#2d6a8a]" /> Major Bhutan Festivals
                    </h3>
            ...
            <article className="lg:col-span-8 w-full overflow-hidden">
              ...
              <section className="mb-6 md:mb-12" id="overview">
                ...
                <div className="prose prose-slate max-w-none">
                  ...
                  <p className="text-slate-600 leading-relaxed text-xs md:text-base">
                    Beyond the festival, this carefully paced itinerary includes visits to <strong>Punakha Dzong</strong> 
                    (Bhutan's most beautiful fortress), the <strong>Dochula Pass</strong> with its 108 chortens, and 
                    culminates with the iconic <strong>hike to Taktsang Monastery (Tiger's Nest)</strong>. With all 
                    meals, visas, and the Sustainable Development Fee included, this is a complete cultural immersion 
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg md:rounded-2xl p-3 md:p-6 flex gap-2 md:gap-4 mb-6 md:mb-12">
                ...
                <div>
                  <h4 className="font-bold text-amber-800 mb-1 md:mb-2 text-xs md:text-base">Important Festival Information</h4>
