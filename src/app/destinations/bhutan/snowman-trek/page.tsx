          ...
          <div className="max-w-5xl mx-auto text-center w-full">
            <div className="flex flex-wrap gap-2 mb-4 md:mb-6 justify-center">
              ...
              <Badge className="bg-red-100 text-red-700 border-none font-bold px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm">
                <Trophy className="w-3 h-3 mr-1" /> World's Hardest Trek
              </Badge>
              <Badge className="bg-blue-100 text-blue-700 border-none font-bold px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm">
                <MountainSnow className="w-3 h-3 mr-1" /> 11 Passes  more than 4,500m
              </Badge>
            </div>
          ...
          <div className="grid lg:grid-cols-12 gap-4 md:gap-10">
            ...
            <article className="lg:col-span-8 w-full overflow-hidden">
              ...
              <section className="mb-6 md:mb-12" id="overview">
                ...
                <div className="prose prose-slate max-w-none">
                  <p className="text-slate-600 leading-relaxed mb-2 md:mb-4 text-xs md:text-base">
                    ...
                    Tibetan border, this trek is the ultimate challenge for serious trekkers.
                  </p>
                  <p className="text-slate-600 leading-relaxed mb-2 md:mb-4 text-xs md:text-base">
                  ...
                  <p className="text-slate-600 leading-relaxed text-xs md:text-base">
                    This is not just a trek; it's a true expedition requiring excellent physical fitness, mental fortitude, 
                    and previous high-altitude trekking experience. With full camping support, expert guides, and comprehensive 
                    safety measures including a Gamow bag for altitude emergencies, we ensure the best possible support for 
                    this ultimate Himalayan adventure. Completion of the Snowman Trek is a lifetime achievement.
                  </p>
                </div>
              </section>
              ...
              <section className="mb-6 md:mb-12">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 md:gap-4">
                  ...
                  <Card className="bg-gradient-to-br from-amber-50 to-orange-50 border-amber-200/50 rounded-lg md:rounded-2xl">
                    <CardContent className="p-3 md:p-5">
                      <div className="flex items-center gap-2 mb-1 md:mb-3">
                        <Sunrise className="w-4 h-4 md:w-5 md:h-5 text-amber-500" />
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg md:rounded-2xl p-3 md:p-6 flex gap-2 md:gap-4 mb-6 md:mb-12">
                <ShieldAlert className="w-4 h-4 md:w-6 md:h-6 text-amber-600 shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-bold text-amber-800 mb-1 md:mb-2 text-xs md:text-base">Critical Information - Please Read Carefully</h4>
