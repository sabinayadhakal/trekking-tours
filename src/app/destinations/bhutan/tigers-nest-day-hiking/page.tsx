                      ...
                      {trailInfo.map((section, index) => (
                        <div key={index} className="border-b border-[#C5E0ED]/20 last:border-0 pb-3 last:pb-0">
                          <div className="flex flex-wrap items-center gap-2 mb-1">
                            <Badge className="bg-[#C5E0ED]/30 text-[#0f2940] font-bold text-xs">
                              {section.section}
                            </Badge>
                            <span className="text-xs text-slate-500">{section.time}</span>
                            <span className="text-xs text-slate-500">{section.elevation}</span>
                          </div>
                          <p className="text-slate-600 text-xs md:text-sm mb-1">
                            <span className="font-medium">Difficulty:</span> {section.difficulty}
                          </p>
                          <p className="text-slate-600 text-xs md:text-sm">{section.description}</p>
                        </div>
                      ))}
                    </div>
                    <div className="mt-4 bg-amber-50 p-2 rounded-lg">
                      <p className="text-amber-700 text-xs flex items-start gap-1">
