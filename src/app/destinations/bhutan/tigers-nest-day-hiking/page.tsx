...
export default function TigersNestDayHikingPage() {
  ...
  const orgSchema = {
    ...
    "description": "Expert-guided Tiger's Nest day hiking packages in Bhutan. Hike to Taktsang Monastery with certified guides.",
    "address": {
      "@type": "PostalAddress",
  ...
  const tourSchema = {
    "@context": "https://schema.org",
    "@type": "Product",
    "name": "Tiger's Nest Day Hiking - 3 Days",
    ...
    "additionalProperty": [
      ...
      },
      {
        "@type": "PropertyValue",
        "name": "Destinations",
        "value": "Paro, Taktsang Monastery"
      },
      {
        "@type": "PropertyValue",
        "name": "Highlights",
        "value": "Tiger's Nest Monastery, Rinpung Dzong, National Museum, Traditional Farmhouse Dinner"
      }
    ]
  };
            ...
            <div className="lg:grid lg:grid-cols-12 lg:gap-4 lg:gap-10">
                ...
                <div className="sticky top-24">
                  <div className="space-y-4 md:space-y-6">
                    ...
                    <Card className="bg-gradient-to-br from-[#0f2940] to-[#1a4166] border-none rounded-xl md:rounded-2xl overflow-hidden">
                      <CardContent className="p-4 md:p-6">
                        ...
                        <a 
                          ...
                          className="block"
                          aria-label="Inquire about Tiger's Nest hiking on WhatsApp"
                        >
                    ...
                    <Card className="bg-[#f8fbfc] border-[#C5E0ED]/30 rounded-xl md:rounded-2xl overflow-hidden">
                      <CardContent className="p-4 md:p-6">
                        <h3 className="font-bold text-[#0f2940] mb-3 md:mb-4 flex items-center gap-2 text-[10px] md:text-base">
                          <Milestone className="w-3 h-3 md:w-4 md:h-4 text-[#2d6a8a]" aria-hidden="true" /> Trail Summary
                        </h3>
              ...
              <article className="lg:col-span-8 w-full overflow-hidden mt-6 lg:mt-0">
                ...
                <section className="mb-6 md:mb-12" id="overview">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Overview of Tiger's Nest Day Hiking</h2>
                  <div className="prose prose-slate max-w-none">
                    <p className="text-slate-600 leading-relaxed mb-2 md:mb-4 text-xs md:text-base">
                      ...
                      This 3-day <strong>Bhutan hiking</strong> experience is designed specifically for those who want to focus on 
                      this legendary hike while also experiencing the best of Bhutanese culture and hospitality.
                    </p>
                    <p className="text-slate-600 leading-relaxed mb-2 md:mb-4 text-xs md:text-base">
                ...
                <section className="mb-6 md:mb-12" id="highlights">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Tiger's Nest Hiking Highlights</h2>
                ...
                <section className="mb-6 md:mb-12">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Best Time to Hike Tiger's Nest</h2>
                ...
                <section className="mb-6 md:mb-12" id="itinerary">
                  <div className="flex items-center justify-between mb-3 md:mb-6">
                    <h2 className="text-lg md:text-2xl font-serif text-[#0f2940]">Day-by-Day Tiger's Nest Itinerary</h2>
                    <Button
                      variant="outline"
                      size="sm"
                ...
                <section className="mb-6 md:mb-12" id="includes">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">What's Included in This Tiger's Nest Day Hike</h2>
                ...
                <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-4">Important Information for Tiger's Nest Hiking</h2>
                ...
                <section className="mb-6 md:mb-12" id="gallery">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Photo Gallery - Tiger's Nest Day Hiking</h2>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-1 md:gap-3">
                    {gallery.map((image, i) => (
                      ...
                      >
                        <Image
                          src={image.src}
                          alt={`${image.alt} - Tiger's Nest day hiking experience in Bhutan`}
                          fill
                ...
                <section className="mb-6 md:mb-12" id="faq">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Frequently Asked Questions About Tiger's Nest Hiking</h2>
