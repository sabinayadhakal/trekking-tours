...
export default function DelightfulBhutanTourPage() {
  ...
  const orgSchema = {
    ...
    "description": "Expert-guided Bhutan tour packages. 5-Day Delightful Bhutan Tour exploring Paro, Thimphu, Punakha, and Tiger's Nest.",
    "address": {
      "@type": "PostalAddress",
  ...
  const productSchema = {
    "@context": "https://schema.org",
    "@type": "Product",
    "name": "5-Day Delightful Bhutan Tour",
    ...
    "additionalProperty": [
      ...
      },
      {
        "@type": "PropertyValue",
        "name": "Highlights",
        "value": "Tiger's Nest Monastery, Punakha Dzong, Dochula Pass, Tashichho Dzong"
      }
    ]
  };
            ...
            <div className="max-w-5xl mx-auto text-center w-full">
              <div className="flex flex-wrap gap-2 mb-4 md:mb-6 justify-center">
                ...
                <Badge className="bg-green-100 text-green-700 border-none font-bold px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm">
                  <Award className="w-3 h-3 mr-1" aria-hidden="true" /> Delightful Experience
                </Badge>
                <Badge className="bg-amber-100 text-amber-700 border-none font-bold px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm">
                  <Landmark className="w-3 h-3 mr-1" aria-hidden="true" /> 3 Valleys
                </Badge>
              </div>
            ...
            <div className="lg:grid lg:grid-cols-12 lg:gap-4 lg:gap-10">
                  ...
                  <Card className="bg-gradient-to-br from-[#0f2940] to-[#1a4166] border-none rounded-xl md:rounded-2xl overflow-hidden">
                    <CardContent className="p-4 md:p-6">
                      ...
                      <a 
                        ...
                        className="block"
                        aria-label="Inquire about Delightful Bhutan tour on WhatsApp"
                      >
              ...
              <article className="lg:col-span-8 w-full overflow-hidden">
                ...
                <section className="mb-6 md:mb-12" id="overview">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Overview of 5-Day Delightful Bhutan Tour</h2>
                  <div className="prose prose-slate max-w-none">
                    <p className="text-slate-600 leading-relaxed mb-2 md:mb-4 text-xs md:text-base">
                      ...
                      crafted <strong>Bhutan tour</strong> takes you through three of Bhutan's most beautiful western valleys: 
                ...
                <section className="mb-6 md:mb-12" id="highlights">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Delightful Bhutan Tour Highlights</h2>
                ...
                <section className="mb-6 md:mb-12" id="itinerary">
                  <div className="flex items-center justify-between mb-3 md:mb-6">
                    <h2 className="text-lg md:text-2xl font-serif text-[#0f2940]">Day-by-Day Delightful Bhutan Itinerary</h2>
                    <Button
                      variant="outline"
                      size="sm"
                ...
                <section className="mb-6 md:mb-12" id="includes">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">What's Included in This Delightful Bhutan Tour</h2>
                ...
                <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-4">Important Information for Delightful Bhutan Tour</h2>
                ...
                <section className="mb-6 md:mb-12" id="gallery">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Photo Gallery - Delightful Bhutan Tour</h2>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-1 md:gap-3">
                    {gallery.map((image, i) => (
                      ...
                      >
                        <Image
                          src={image.src}
                          alt={`${image.alt} - 5-Day Delightful Bhutan tour experience`}
                          fill
                ...
                <section className="mb-6 md:mb-12" id="faq">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Frequently Asked Questions About Delightful Bhutan Tour</h2>
