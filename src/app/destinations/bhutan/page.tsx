...
const regions = [
  ...
  },
  {
    name: "Thimphu Valley",
    description:
      "The world's only capital city without traffic lights, where tradition meets modernity. Home to the royal family, government, and a vibrant cultural scene.",
...
export default function BhutanPage() {
  ...
  const [culturalTours, setCulturalTours] = React.useState<ManagedService[]>(
    () =>
      MANAGED_SERVICES_FALLBACK.destinationTours.filter(
        (tour) => tour.destination === "bhutan" && tour.published,
      ),
  );
  ...
  const pageDescription =
    "Bhutan travel & tours: Explore the Last Shangri-La with our expert-guided cultural tours. Visit Tiger's Nest, Thimphu, Punakha, and more.";
  const imageUrl =
    "https://www.himkalaadventure.com/images/used/bhutan-tiger.webp";
            ...
            <div className="mx-auto max-w-[1220px]">
              <div className="flex flex-col gap-4 md:gap-8 md:flex-row md:items-end md:justify-between">
                ...
                <p className="max-w-full md:max-w-[280px] lg:max-w-[380px] text-sm leading-6 text-[#66706d]">
                  Land of the Thunder Dragon — where Gross National Happiness
                  outshines GDP and ancient monasteries cling to cliffs.
                </p>
              </div>
            </div>
          </section>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.05fr] gap-8 sm:gap-12 lg:gap-14 lg:items-center lg:gap-24">
                ...
                <div className="order-1 lg:order-2">
                  ...
                  <div className="mt-4 sm:mt-7 space-y-3 sm:space-y-4 text-[#556363] text-sm leading-relaxed">
                    <p>
                      Nestled in the eastern Himalayas, Bhutan is a landlocked
                      country bordered by China to the north and India to the
                      south, east, and west. Known as{" "}
                      <strong className="text-[#14383b]">
                        Dru U — Land of the Thunder Dragon
                      </strong>
                    ...
                    <p>
                      ...
                      and ranks 8th globally. With its{" "}
                      <strong className="text-[#14383b]">
                        Gross National Happiness
                      </strong>{" "}
                      philosophy, development prioritizes well-being over GDP.{" "}
                      <strong className="text-[#14383b]">
                        Vajrayana Buddhism
                      </strong>{" "}
                    ...
                    <p>
                      From subtropical plains to Himalayan peaks exceeding
                      7,000m, Bhutan offers pristine landscapes, ancient dzongs,
                      and a unique culture preserved by traditional dress and
                      architecture laws.
                    </p>
                  </div>
                </div>
              ...
              <div className="flex flex-col gap-4 md:gap-8 md:flex-row md:items-end md:justify-between">
                <div>
                  ...
                  <h2 className="mt-3 sm:mt-5 font-serif text-[clamp(2rem,6vw,5rem)] leading-[1.05] sm:leading-[.95] tracking-[-.03em] sm:tracking-[-.045em] text-[#14383b]">
                    A Kingdom{" "}
                    <span className="text-[#cf6943]">Like No Other</span>
                  </h2>
                </div>
                <p className="max-w-full md:max-w-[280px] text-sm leading-6 text-[#66706d]">
                  From Gross National Happiness to carbon-negative status,
                  Bhutan offers unique experiences.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    text: "Ranked #1 in Asia and #8 globally for happiness.",
                  },
                  {
                    icon: <Shield className="w-4 h-4 sm:w-5 sm:h-5" />,
                    title: "Carbon Negative",
                    text: "The world's only carbon-negative nation with 72% forest cover.",
                  },
                  {
                    icon: <Flag className="w-4 h-4 sm:w-5 sm:h-5" />,
                    title: "Gross National Happiness",
                    text: "Development prioritizing well-being over GDP.",
                  },
                  {
                    icon: <Users className="w-4 h-4 sm:w-5 sm:h-5" />,
                    title: "Preserved Culture",
                    text: "Traditional dress and architecture preserved by law.",
                  },
                  {
                    icon: <Compass className="w-4 h-4 sm:w-5 sm:h-5" />,
                    title: "Last Shangri-La",
                    text: "Pristine landscapes and untouched traditions.",
                  },
                  {
                    icon: <Heart className="w-4 h-4 sm:w-5 sm:h-5" />,
                    title: "Vajrayana Buddhism",
                    text: "Spiritual home of Tantric Buddhism.",
                  },
                ].map((item, i) => (
                  <div
                    key={i}
            ...
            <div className="mx-auto max-w-[1220px]">
              <div className="flex flex-col gap-4 md:gap-8 md:flex-row md:items-end md:justify-between">
                <div>
                  ...
                  <h2 className="mt-3 sm:mt-5 font-serif text-[clamp(2rem,6vw,5rem)] leading-[1.05] sm:leading-[.95] tracking-[-.03em] sm:tracking-[-.045em] text-[#14383b]">
                    Bhutan{" "}
                    <span className="text-[#cf6943]">Cultural Experiences</span>
                  </h2>
                </div>
                <div className="flex gap-3 sm:gap-4"></div>
              </div>

              <p className="mt-4 sm:mt-6 max-w-2xl text-sm sm:text-[15px] leading-6 sm:leading-7 text-[#556363]">
                Discover Bhutan's rich heritage with our expert-guided tours.
                Minimum daily package applies for sustainable tourism.
              </p>
            ...
            <div className="mx-auto max-w-[1220px]">
              <div className="flex flex-col gap-4 md:gap-8 md:flex-row md:items-end md:justify-between">
                <div>
                  ...
                  <h2 className="mt-3 sm:mt-5 font-serif text-[clamp(2rem,6vw,5rem)] leading-[1.05] sm:leading-[.95] tracking-[-.03em] sm:tracking-[-.045em] text-[#14383b]">
                    Valleys of the{" "}
                    <span className="text-[#cf6943]">Thunder Dragon</span>
                  </h2>
                </div>
                <p className="max-w-full md:max-w-[280px] text-sm leading-6 text-[#66706d]">
                  Carved by ancient rivers and blessed by saints, each valley
                  holds its own stories and traditions.
                </p>
              </div>
            ...
            <div className="mx-auto max-w-[1220px]">
              <div className="flex flex-col gap-4 md:gap-8 md:flex-row md:items-end md:justify-between">
                <div>
                  ...
                  <h2 className="mt-3 sm:mt-5 font-serif text-[clamp(2rem,6vw,5rem)] leading-[1.05] sm:leading-[.95] tracking-[-.03em] sm:tracking-[-.045em] text-[#14383b]">
                    Best Time to{" "}
                    <span className="text-[#cf6943]">Visit Bhutan</span>
                  </h2>
                </div>
              </div>
            ...
            <div className="mx-auto max-w-[1220px]">
              <div className="flex flex-col gap-4 md:gap-8 md:flex-row md:items-end md:justify-between">
                ...
                <p className="max-w-full md:max-w-[280px] text-sm leading-6 text-[#66706d]">
                  ...
                  while creating meaningful experiences.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mt-8 sm:mt-12">
                <div className="space-y-4 sm:space-y-5">
                  {[
                    {
                      title: "Minimum Daily Package",
                      text: "US $200-250 per day includes accommodation, meals, transport, guide, and sustainable development fee.",
                    },
                    {
                      title: "Custom Itineraries",
                      text: "Create your own itinerary — no group travel required. Personal guides for intimate experiences.",
                    },
                    {
                      title: "Cultural Preservation",
                      text: "Traditional dress (Gho & Kira) and architecture preserved by law. No backpacker-style tourism.",
                    },
                    {
                      title: "Carbon Negative",
                      text: "72% forest cover. Tourism supports conservation and community development.",
                    },
                  ].map((item) => (
                    <div
                      key={item.title}
                ...
                <div className="bg-[#f7f2e9] p-5 sm:p-6 md:p-8 rounded-lg border border-[#d8cec0]">
                  ...
                  <ul className="space-y-3">
                    {[
                      <>
                        <strong>Ema Datshi:</strong> National dish — chillies
                        and cheese
                      </>,
                      <>
                        <strong>Red Rice:</strong> Unique to Bhutan, grown in
                        Paro Valley
                      </>,
                      <>
                        <strong>No Smoking:</strong> Tobacco sales are illegal
                        nationwide
                      </>,
                      <>
                        <strong>Protective Symbols:</strong> Houses painted with
                        protective symbols
                      </>,
                      <>
                        <strong>Easy Access:</strong> Just 1-hour flight from
                        Kathmandu to Paro
                      </>,
                      <>
                        <strong>Preserved Heritage:</strong> 17th century dzongs
                        still in use
                      </>,
                    ].map((item, i) => (
