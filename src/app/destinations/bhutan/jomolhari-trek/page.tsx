...
const gallery = [
  {
    ...
    alt: "Trail to Jomolhari Base Camp - scenic trekking route with Himalayan mountain views in Bhutan",
    caption: "Way to Mount Jomolhari (7,314m) - Bhutan's Second Highest Peak",
  },
  {
    src: "/images/used/bhutan-jomolhari.webp",
    alt: "Mount Jomolhari at 7,314m - Bhutan's second highest and most sacred mountain viewed from base camp",
...
export default function JomolhariTrekPage() {
  ...
  const canonicalUrl = "https://www.himkalaadventure.com/destinations/bhutan/jomolhari-trek";
  const pageTitle = "Jomolhari Trek - Himkala Adventure";
  const pageDescription = "Jomolhari Trek: Trek to the base of sacred Mount Jomolhari (7,314m) in Bhutan. Cross Nyile La (4,830m) and Yeli La (4,650m) passes. A challenging Himalayan adventure. Book now!";
  const imageUrl = "https://www.himkalaadventure.com/images/used/bhutan-jomolhari-1.webp";
  ...
  const orgSchema = {
    ...
    "description": "Expert-guided Jomolhari trekking packages in Bhutan. Trek to the base of sacred Mount Jomolhari with certified guides.",
    "address": {
      "@type": "PostalAddress",
  ...
  const trekSchema = {
    ...
    "additionalProperty": [
      ...
      {
        "@type": "PropertyValue",
        "name": "Mount Jomolhari Altitude",
        "value": "7,314m"
      },
      {
        "@type": "PropertyValue",
        "name": "Nyile La Pass Altitude",
        "value": "4,830m"
      },
      {
        "@type": "PropertyValue",
        "name": "Yeli La Pass Altitude",
        "value": "4,650m"
      },
      {
        "@type": "PropertyValue",
      ...
      },
      {
        "@type": "PropertyValue",
        "name": "Highlights",
        "value": "Mount Jomolhari, Nyile La Pass, Yeli La Pass, Jangothang Base Camp, Lingshi Dzong"
      }
    ]
  };
      ...
      <div className="min-h-screen bg-white overflow-x-hidden">
        ...
        <section className="relative h-[45vh] min-h-[380px] md:h-[60vh] md:min-h-[500px] overflow-hidden bg-[#0f2940]">
          <div className="absolute inset-0 z-0">
            <Image
              src="/images/used/bhutan-jomolhari-1.webp"
              alt="Jomolhari Trek - challenging Himalayan trek to the base of sacred Mount Jomolhari in Bhutan"
              fill
            ...
            <div className="max-w-5xl mx-auto text-center w-full">
              <div className="flex flex-wrap gap-2 mb-4 md:mb-6 justify-center">
                ...
                <Badge className="bg-orange-100 text-orange-700 border-none font-bold px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm">
                  <Mountain className="w-3 h-3 mr-1" aria-hidden="true" /> Challenging Trek
                </Badge>
                <Badge className="bg-blue-100 text-blue-700 border-none font-bold px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm">
                  <MountainSnow className="w-3 h-3 mr-1" aria-hidden="true" /> 4,830m Pass
                </Badge>
              </div>
            ...
            <div className="lg:grid lg:grid-cols-12 lg:gap-4 lg:gap-10">
                  ...
                  <Card className="bg-gradient-to-br from-[#0f2940] to-[#1a4166] border-none rounded-xl md:rounded-2xl overflow-hidden">
                    <CardContent className="p-4 md:p-6">
                      ...
                      <a 
                        ...
                        className="block"
                        aria-label="Inquire about Jomolhari trek on WhatsApp"
                      >
              ...
              <article className="lg:col-span-8 w-full overflow-hidden">
                ...
                <section className="mb-6 md:mb-12" id="overview">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Overview of Jomolhari Trek</h2>
                  <div className="prose prose-slate max-w-none">
                    ...
                    <p className="text-slate-600 leading-relaxed text-xs md:text-base">
                      This challenging but rewarding <strong>Jomolhari trekking</strong> adventure is perfect for 
                      experienced trekkers seeking an authentic Himalayan wilderness experience. With full camping 
                      support, expert guides, and all meals included, the Jomolhari Trek offers an unforgettable 
                      adventure through the sacred landscapes of the Land of the Thunder Dragon.
                    </p>
                  </div>
                </section>
                ...
                <section className="mb-6 md:mb-12" id="highlights">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Jomolhari Trek Highlights</h2>
                ...
                <section className="mb-6 md:mb-12">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Best Time to Trek Jomolhari</h2>
                    ...
                    <Card className="bg-gradient-to-br from-orange-50 to-amber-50 border-orange-200/50 rounded-lg md:rounded-2xl">
                      <CardContent className="p-3 md:p-5">
                        <div className="flex items-center gap-2 mb-1 md:mb-3">
                          ...
                          <h3 className="font-bold text-[#0f2940] text-xs md:text-base">Spring (Apr - May)</h3>
                        </div>
                ...
                <section className="mb-6 md:mb-12" id="itinerary">
                  <div className="flex items-center justify-between mb-3 md:mb-6">
                    <h2 className="text-lg md:text-2xl font-serif text-[#0f2940]">Day-by-Day Jomolhari Itinerary</h2>
                    <Button
                      variant="outline"
                      size="sm"
                ...
                <section className="mb-6 md:mb-12" id="includes">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">What's Included in This Jomolhari Trek</h2>
                ...
                <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-4">Important Information for Jomolhari Trek</h2>
                ...
                <section className="mb-6 md:mb-12" id="gallery">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Photo Gallery - Jomolhari Trek</h2>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-1 md:gap-3">
                    {gallery.map((image, i) => (
                      ...
                      >
                        <Image
                          src={image.src}
                          alt={`${image.alt} - Jomolhari trekking experience in Bhutan`}
                          fill
                ...
                <section className="mb-6 md:mb-12" id="faq">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Frequently Asked Questions About Jomolhari Trek</h2>
