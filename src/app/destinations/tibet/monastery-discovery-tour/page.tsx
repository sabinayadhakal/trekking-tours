...
const gallery = [
  ...
  
  {
    ...
    alt: "Prayer wheels at Tibetan monastery - traditional Buddhist practice for spiritual merit",
    caption: "Prayer Wheels at Monastery",
  },
 
  {
    src: "/images/used/jokhang-monk.webp",
    alt: "Tibetan monk in prayer at Jokhang Monastery - spiritual devotion in Lhasa, Tibet",
    caption: "Monk in Prayer at Monastery",
  },
  
    {
    src: "/images/used/tibet-prayers.webp",
    alt: "Butter lamps offering at Jokhang Monastery in Lhasa, Tibet - sacred Buddhist ritual",
...
export default function MonasteryDiscoveryTourPage() {
  ...
  const canonicalUrl = "https://www.himkalaadventure.com/tours/monastery-discovery-tour";
  const pageTitle = "6-Day Monastery Discovery Tour - Tibet Buddhist Monasteries";
  const pageDescription = "6-Day Monastery Discovery Tour: Explore six of Tibet's most significant monasteries including Jokhang, Drepung, Sera, and Ganden. Witness monk debates and Buddhist heritage. Book now!";
  ...
  const orgSchema = {
    ...
    "description": "Expert-guided Monastery Discovery Tours in Tibet. Explore Jokhang, Drepung, Sera, and Ganden monasteries with certified guides.",
    "address": {
      "@type": "PostalAddress",
  ...
  const tourSchema = {
    "@context": "https://schema.org",
    "@type": "Product",
    "name": "6-Day Monastery Discovery Tour",
    ...
    "additionalProperty": [
      ...
      },
      {
        "@type": "PropertyValue",
        "name": "Highlights",
        "value": "Jokhang Temple, Drepung Monastery, Sera Monastery, Ganden Monastery, Nechung Monastery, Ramoche Monastery"
      }
    ]
  };
              ...
              <div className="mt-8 pt-6 border-t border-slate-200">
                <div className="flex gap-2">
                  <Button
                    ...
                    aria-label="Share Monastery Discovery Tour on Facebook"
                  >
                  ...
                  <Button
                    ...
                    aria-label="Share Monastery Discovery Tour on Twitter"
                  >
                  ...
                  <Button
                    ...
                    aria-label="Copy Monastery Discovery Tour link to clipboard"
                  >
      ...
      <section className="relative h-[45vh] min-h-[380px] md:h-[60vh] md:min-h-[500px] overflow-hidden bg-[#0f2940]">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="Tibetan Buddhist monastery discovery tour exploring ancient monasteries and spiritual heritage in Lhasa, Tibet"
            fill
          ...
          <div className="max-w-5xl mx-auto text-center w-full">
            <div className="flex flex-wrap gap-2 mb-4 md:mb-6 justify-center">
              ...
              <Badge className="bg-amber-100 text-amber-700 border-none font-bold px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm">
                <Landmark className="w-3 h-3 mr-1" aria-hidden="true" /> Monastery Discovery
              </Badge>
              <Badge className="bg-purple-100 text-purple-700 border-none font-bold px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm">
                <Scroll className="w-3 h-3 mr-1" aria-hidden="true" /> Buddhist Heritage
              </Badge>
            </div>
          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-4 lg:gap-10">
            ...
            <aside className="hidden lg:block lg:col-span-4">
              <div className="sticky top-24 space-y-4 md:space-y-6">
                ...
                <Card className="bg-gradient-to-br from-[#0f2940] to-[#1a4166] border-none rounded-xl md:rounded-2xl overflow-hidden">
                  <CardContent className="p-4 md:p-6">
                    ...
                    <a 
                      ...
                      aria-label="Inquire about Monastery Discovery Tour on WhatsApp"
                    >
                ...
                <Card className="bg-[#f8fbfc] border-[#C5E0ED]/30 rounded-xl md:rounded-2xl overflow-hidden">
                  <CardContent className="p-4 md:p-6">
                    <h3 className="font-bold text-[#0f2940] mb-3 md:mb-4 flex items-center gap-2 text-sm md:text-base">
                      <Landmark className="w-3 h-3 md:w-4 md:h-4 text-[#2d6a8a]" aria-hidden="true" /> Monasteries of the Tour
                    </h3>
            ...
            <article className="lg:col-span-8 w-full overflow-hidden mt-6 lg:mt-0">
              ...
              <section className="mb-6 md:mb-12" id="overview">
                <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Overview of Monastery Discovery Tour</h2>
              ...
              <section className="mb-6 md:mb-12" id="highlights">
                <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Monastery Discovery Tour Highlights</h2>
                  ...
                  <Card className="bg-gradient-to-br from-green-50 to-emerald-50 border-green-200/50 rounded-lg md:rounded-2xl">
                    <CardContent className="p-3 md:p-5">
                      <div className="flex items-center gap-2 mb-1 md:mb-3">
                        ...
                        <h3 className="font-bold text-[#0f2940] text-xs md:text-base">Summer (May - Aug)</h3>
                      </div>
                ...
                <Card className="bg-gradient-to-br from-purple-50 to-indigo-50 border-purple-200/50 rounded-lg md:rounded-2xl overflow-hidden">
                  <CardContent className="p-3 md:p-5">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mt-2">
                      ...
                      <div className="bg-white/80 p-2 rounded-lg text-center">
                        <BookOpen className="w-4 h-4 mx-auto text-[#2d6a8a] mb-1" aria-hidden="true" />
                      ...
                      <div className="bg-white/80 p-2 rounded-lg text-center">
                        <Scroll className="w-4 h-4 mx-auto text-[#2d6a8a] mb-1" aria-hidden="true" />
              ...
              <section className="mb-6 md:mb-12" id="itinerary">
                <div className="flex items-center justify-between mb-3 md:mb-6">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940]">Day-by-Day Monastery Discovery Itinerary</h2>
                  <Button
                    variant="outline"
                    size="sm"
              ...
              <section className="mb-6 md:mb-12" id="includes">
                <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">What's Included in Monastery Discovery Tour</h2>
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg md:rounded-2xl p-3 md:p-6 flex gap-2 md:gap-4 mb-6 md:mb-12">
                ...
                <div>
                  <h3 className="font-bold text-amber-800 mb-1 md:mb-2 text-xs md:text-base">Important Information - Monastery Visits</h3>
              ...
              <section className="mb-6 md:mb-12" id="gallery">
                <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Monastery Discovery Photo Gallery</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 gap-1 md:gap-3">
                  {gallery.map((image, i) => (
                    ...
                    >
                      <Image
                        src={image.src}
                        alt={`${image.alt} - Monastery Discovery Tour experience`}
                        fill
              ...
              <section className="mb-6 md:mb-12" id="faq">
                <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Frequently Asked Questions About Monastery Discovery Tour</h2>
