...
const formatPrice = (price: ManagedService["price"]) =>
  typeof price === "number" ? `$${price.toLocaleString("en-US")}` : price;

const legacyCulturalTours = [
  {
    ...
    description:
      "Experience Tibet's rich cultural heritage and spiritual traditions.",
...
const regions = [
  {
    name: "Ü-Tsang",
    description:
      "The cultural and spiritual heartland of Tibet, centered around the sacred city of Lhasa. Home to the Potala Palace, Jokhang Temple, and the great monastic universities of Drepung, Sera, and Ganden.",
    highlights: [
  ...
  },
  {
    name: "Kham",
    description:
      "A land of rugged mountains and deep gorges, known for its distinctive art, music, and the legendary Khampa warriors. The region's unique dialect and traditions reflect its fierce independent spirit.",
    highlights: [
      "Renowned for thangka painting",
      "Traditional Khampa horsemanship",
  ...
  },
  {
    name: "Amdo",
    description:
      "Vast grasslands stretching across northeastern Tibet, home to nomadic communities and some of Tibet's most influential monasteries. Birthplace of the 14th Dalai Lama and many great Buddhist masters.",
    highlights: [
  ...
  },
  {
    name: "Ngari",
    description:
      "The 'roof of the roof of the world,' encompassing the sacred Mount Kailash and Lake Mansarovar. This remote western region holds the ruins of the ancient Guge Kingdom and some of Tibet's oldest Buddhist sites.",
    highlights: [
...
export default function TibetPage() {
  ...
  const [culturalTours, setCulturalTours] = React.useState<ManagedService[]>(
    () =>
      MANAGED_SERVICES_FALLBACK.destinationTours.filter(
        (tour) => tour.destination === "tibet" && tour.published,
      ),
  );

  const refreshTours = React.useCallback(() => {
    void loadManagedServices("destinationTours").then(({ services }) =>
      setCulturalTours(
        services.filter(
          (tour) => tour.destination === "tibet" && tour.published,
        ),
  ...
  React.useEffect(() => {
    ...
    const onUpdate = (event: Event) => {
      if ((event as CustomEvent).detail === "destinationTours") refreshTours();
    };
    window.addEventListener(MANAGED_SERVICES_UPDATED_EVENT, onUpdate);
    return () =>
      window.removeEventListener(MANAGED_SERVICES_UPDATED_EVENT, onUpdate);
  }, [refreshTours]);

  void legacyCulturalTours;
  ...
  const pageDescription =
    "Tibet travel & tours: Explore the Roof of the World with our expert-guided cultural tours. Visit Lhasa, Potala Palace, and more.";
  const imageUrl =
    "https://www.himkalaadventure.com/images/used/tibet-main-page.webp";
    ...
    <>
      ...
      <div className="flex flex-col min-h-screen bg-[#f2ede4] overflow-x-hidden">
        <main>
            ...
            <div className="mx-auto max-w-[1220px]">
              <div className="flex flex-col gap-4 md:gap-8 md:flex-row md:items-end md:justify-between">
                ...
                <p className="max-w-full md:max-w-[280px] lg:max-w-[380px] text-sm leading-6 text-[#66706d]">
                  Roof of the World — where ancient monasteries cling to
                  mountains and the spiritual heart of Tibetan Buddhism beats
                  strong.
                </p>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.05fr] gap-8 sm:gap-12 lg:gap-14 lg:items-center lg:gap-24">
                <div className="relative min-h-[280px] sm:min-h-[350px] md:min-h-[400px] lg:min-h-[480px] order-2 lg:order-1">
                  ...
                  <div className="absolute bottom-0 left-0 bg-[#e47a4f] px-4 sm:px-6 py-3 sm:py-4 md:py-5 text-[#fff8ee] sm:px-8">
                    <div className="font-serif text-2xl sm:text-3xl md:text-4xl leading-none">
                      4,500<span className="text-xl sm:text-2xl">m</span>
                    </div>
                    <div className="mt-1 sm:mt-2 text-[8px] sm:text-[10px] font-bold tracking-[.15em]">
                      AVERAGE ELEVATION
                    </div>
                  </div>
                </div>
                <div className="order-1 lg:order-2">
                  ...
                  <h2 className="mt-3 sm:mt-5 font-serif text-[clamp(2rem,6vw,4.8rem)] leading-[1.05] sm:leading-[.96] tracking-[-.03em] sm:tracking-[-.045em] text-[#14383b]">
                    The Spiritual{" "}
                    <span className="text-[#cf6943]">Roof of the World</span>
                  </h2>
                  <div className="mt-4 sm:mt-7 space-y-3 sm:space-y-4 text-[#556363] text-sm leading-relaxed">
                    <p>
                      Tibet is culturally and historically rich, where{" "}
                      <strong className="text-[#14383b]">
                        Tibetan Buddhism
                      </strong>{" "}
                      holds a special position of interest in the world. It can
                      be said to be the dwelling place of gods, lokeshvara,
                      tantra, and spiritual spirits.
                    </p>
                    <p>
                      The many-storied{" "}
                      <strong className="text-[#14383b]">Potala Palace</strong>{" "}
                      towers above Lhasa like a celestial realm suspended in
                      air. <strong className="text-[#14383b]">Lhasa</strong>{" "}
                      contains treasures like the{" "}
                      <strong className="text-[#14383b]">Barkhor</strong> market
                      circuit and the mysterious{" "}
                      <strong className="text-[#14383b]">Jokhang Temple</strong>
                      , Tibet's most sacred shrine.
                    </p>
                    <p>
                      Tibet was a land of many principalities with different
                      dialects and styles of dress. Multiple sects and subsects
                      of Tibetan Buddhism created one of the world's greatest
                      and most complex religious traditions, all enriching each
                      other.
                    </p>
                  </div>
                </div>
              ...
              <div className="flex flex-col gap-4 md:gap-8 md:flex-row md:items-end md:justify-between">
                <div>
                  ...
                  <h2 className="mt-3 sm:mt-5 font-serif text-[clamp(2rem,6vw,5rem)] leading-[1.05] sm:leading-[.95] tracking-[-.03em] sm:tracking-[-.045em] text-[#14383b]">
                    A Land of{" "}
                    <span className="text-[#cf6943]">Spiritual Wonder</span>
                  </h2>
                </div>
                <p className="max-w-full md:max-w-[280px] text-sm leading-6 text-[#66706d]">
                  From ancient monasteries to breathtaking landscapes, Tibet
                ...
                {[
                  {
                    ...
                    text: "Highest plateau on Earth with average elevation over 4,500m.",
                  },
                  {
                    icon: <Heart className="w-4 h-4 sm:w-5 sm:h-5" />,
                    title: "Spiritual Heartland",
                    text: "Center of Tibetan Buddhism with thousand-year traditions.",
                  },
                  {
                    icon: <Eye className="w-4 h-4 sm:w-5 sm:h-5" />,
                    title: "Potala Palace",
                    text: "UNESCO World Heritage site and architectural wonder.",
                  },
                  {
                    icon: <Wind className="w-4 h-4 sm:w-5 sm:h-5" />,
                    title: "Ancient Kingdoms",
                    text: "Land of diverse principalities, dialects, and traditions.",
                  },
                  {
                    icon: <Compass className="w-4 h-4 sm:w-5 sm:h-5" />,
                    title: "Himalayan Vistas",
                    text: "Spectacular views of the world's highest mountains.",
                  },
                  {
                    icon: <Moon className="w-4 h-4 sm:w-5 sm:h-5" />,
                    title: "Sacred Lakes",
                    text: "Turquoise holy lakes like Namtso and Yamdrok.",
                  },
                ].map((item, i) => (
                  <div
                    key={i}
                    className="bg-[#f7f2e9] overflow-hidden shadow-sm hover:shadow-md transition-all duration-300"
                  >
          ...
          <section
            id="tours"
            className="bg-[#f2ede4] px-4 sm:px-5 md:px-8 py-12 sm:py-16 md:py-20 lg:py-28 border-t border-[#d8cec0]/30"
          >
            <div className="mx-auto max-w-[1220px]">
              <div className="flex flex-col gap-4 md:gap-8 md:flex-row md:items-end md:justify-between">
                <div>
                  ...
                  <h2 className="mt-3 sm:mt-5 font-serif text-[clamp(2rem,6vw,5rem)] leading-[1.05] sm:leading-[.95] tracking-[-.03em] sm:tracking-[-.045em] text-[#14383b]">
                    Spiritual &{" "}
                    <span className="text-[#cf6943]">Cultural Journeys</span>
                  </h2>
                </div>
                    ...
                    >
                      <div className="bg-[#f7f2e9] border border-[#d8cec0] overflow-hidden rounded-lg shadow-sm hover:shadow-md transition-all duration-300">
                        ...
                        <CardContent className="p-4 sm:p-5 md:p-6">
                          <h3 className="text-lg sm:text-xl font-bold text-[#14383b] mb-1">
                            {tour.cardTitle || tour.name}
                          </h3>
                          <p className="text-[#66706d] text-xs sm:text-sm mb-2">
                            {tour.region}
                          </p>
                          <p className="text-[#556363] text-sm sm:text-base mb-3 sm:mb-4 leading-relaxed">
                            {tour.cardDescription || tour.description}
                          </p>
                          <div className="flex flex-wrap gap-1.5 sm:gap-2 mb-3 sm:mb-4">
                            {tour.highlights.slice(0, 3).map((h) => (
                              <span
                                key={h}
                                className="text-[10px] sm:text-xs border border-[#d8cec0] text-[#556363] px-2 sm:px-3 py-0.5 sm:py-1 rounded"
                              >
                                {h}
                              </span>
                            ))}
                          ...
                          <div className="flex items-center justify-between">
                            <span className="text-xl sm:text-2xl font-bold text-[#0f2940]">
                            ...
                            <Button
                              ...
                              onClick={(e) => {
                                e.preventDefault();
                                handleBookNow(tour.cardTitle || tour.name);
                              }}
                            >
                              Book Now
                            </Button>
              ...
              <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-3 gap-5 mt-12">
                {culturalTours.map((tour) => (
                  <Link key={tour.id} href={tour.link} className="group block">
                    <div className="bg-[#f7f2e9] border border-[#d8cec0] overflow-hidden hover:shadow-md transition-all duration-300 rounded-lg h-full">
                      ...
                      <CardContent className="p-6">
                        <h3 className="text-xl font-bold text-[#14383b] mb-1">
                          {tour.cardTitle || tour.name}
                        </h3>
                        <p className="text-[#66706d] text-sm mb-2">
                          {tour.region}
                        </p>
                        <p className="text-[#556363] text-sm mb-4 leading-relaxed">
                          {tour.cardDescription || tour.description}
                        </p>
                        <div className="flex flex-wrap gap-1.5 mb-4">
                          {tour.highlights.slice(0, 3).map((h) => (
                            <span
                              key={h}
                              className="text-xs border border-[#d8cec0] text-[#556363] px-2.5 py-1 rounded"
                            >
                              {h}
                            </span>
                          ))}
          ...
          <section
            id="regions"
            className="bg-[#e4d8c8] px-4 sm:px-5 md:px-8 py-12 sm:py-16 md:py-20 lg:py-28"
          >
            <div className="mx-auto max-w-[1220px]">
              <div className="flex flex-col gap-4 md:gap-8 md:flex-row md:items-end md:justify-between">
                <div>
                  ...
                  <h2 className="mt-3 sm:mt-5 font-serif text-[clamp(2rem,6vw,5rem)] leading-[1.05] sm:leading-[.95] tracking-[-.03em] sm:tracking-[-.045em] text-[#14383b]">
                    The Four{" "}
                    <span className="text-[#cf6943]">Pillars of Tibet</span>
                  </h2>
                </div>
                <p className="max-w-full md:max-w-[280px] text-sm leading-6 text-[#66706d]">
                  Ancient kingdoms and sacred valleys, each holding centuries of
                  wisdom within their mountains and monasteries.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mt-8 sm:mt-12">
                {regions.map((region, index) => (
                  <div
                    key={index}
                    className="bg-[#f7f2e9] p-5 sm:p-6 md:p-8 rounded-lg border border-[#d8cec0] hover:shadow-md transition-all duration-300"
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <h3 className="text-xl sm:text-2xl font-serif text-[#14383b] mb-2">
                          {region.name}
                        </h3>
            ...
            <div className="mx-auto max-w-[1220px]">
              <div className="flex flex-col gap-4 md:gap-8 md:flex-row md:items-end md:justify-between">
                <div>
                  ...
                  <h2 className="mt-3 sm:mt-5 font-serif text-[clamp(2rem,6vw,5rem)] leading-[1.05] sm:leading-[.95] tracking-[-.03em] sm:tracking-[-.045em] text-[#14383b]">
                    Best Time to{" "}
                    <span className="text-[#cf6943]">Visit Tibet</span>
                  </h2>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 mt-8 sm:mt-12">
                {[
                  ...
                  <div
                    key={season.season}
                    className="bg-[#f7f2e9] p-5 sm:p-6 rounded-lg border border-[#d8cec0] hover:shadow-md transition-all duration-300"
                  >
                    ...
                    <p className="text-[#66706d] text-sm mb-3">
                      {season.months}
                    </p>
                    <ul className="space-y-1.5">
                      {season.highlights.map((h) => (
                        <li
                          key={h}
                          className="flex items-center gap-2 text-sm text-[#556363]"
                        >
                          <CheckCircle
                            className="w-3 h-3 text-[#cf6943]"
                            aria-hidden="true"
                          />
                          <span>{h}</span>
                        </li>
          ...
          <section className="bg-[#e4d8c8] px-4 sm:px-5 md:px-8 py-12 sm:py-16 md:py-20 lg:py-28">
            <div className="mx-auto max-w-[1220px]">
              <div className="flex flex-col gap-4 md:gap-8 md:flex-row md:items-end md:justify-between">
                ...
                <p className="max-w-full md:max-w-[280px] text-sm leading-6 text-[#66706d]">
                  Everything you need to know for your journey to the Roof of
                  the World.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mt-8 sm:mt-12">
                <div className="space-y-4 sm:space-y-5">
                  {[
                    {
                      title: "Easy Access from Nepal",
                      text: "Regular flights between Kathmandu and Lhasa (1 hour). Overland route via Friendship Highway offers spectacular Himalayan views.",
                    },
                    {
                      title: "Overland Route Experience",
                      text: "Spectacular view of the Himalayas from Tibetan plateau. See white glaciers, multi-colored hills, turquoise lakes, and ancient monastic cities.",
                    },
                    {
                      title: "Cultural Diversity",
                      text: "Experience the wonderful diversity of Tibetan people and culture across different regions — what made Tibet remarkable.",
                    },
                    {
                      title: "Permits & Regulations",
                      text: "Tibet Travel Permit required for all visitors. We handle all paperwork including China Group Visa and Tibet Travel Permits.",
                    },
                  ].map((item) => (
                    <div
                      key={item.title}
                    ...
                    >
                      ...
                      <div>
                        <h3 className="font-bold text-[#14383b] text-sm sm:text-base mb-0.5 sm:mb-1">
                          {item.title}
                        </h3>
                ...
                <div className="bg-[#f7f2e9] p-5 sm:p-6 md:p-8 rounded-lg border border-[#d8cec0]">
                  <h3 className="font-bold text-[#14383b] text-lg sm:text-xl mb-4">
                    What to Expect in Tibet
                  </h3>
                  <ul className="space-y-3">
                    {[
                      <>
                        <strong>High Altitude:</strong> Lhasa at 3,650m, gradual
                        acclimatization important
                      </>,
                      <>
                        <strong>Spiritual Atmosphere:</strong> Active
                        monasteries with praying monks and pilgrims
                      </>,
                      <>
                        <strong>Architectural Marvels:</strong> Ancient dzongs,
                        palaces, and monastic complexes
                      </>,
                      <>
                        <strong>Dramatic Landscapes:</strong> Vast plateaus,
                        turquoise lakes, snow-capped peaks
                      </>,
                      <>
                        <strong>Local Cuisine:</strong> Tsampa, butter tea,
                        momos, and Tibetan noodle soups
                      </>,
                    ].map((item, i) => (
                      <li key={i} className="flex items-start gap-2 sm:gap-3">
                        <CheckCircle className="w-4 h-4 text-[#cf6943] mt-0.5 flex-shrink-0" />
                        <span className="text-[#556363] text-sm sm:text-base">
                          {item}
                        </span>
                      </li>
                    ))}
