...
const gallery = [
  ...
  },
  {
    ...
    alt: "Tibetan plateau landscape - where the sky touches the earth in the Roof of the World",
    caption: "Tibet-Where the sky touches the earth",
  },
  {
    src: "/images/used/yamdrok-lake.webp",
    alt: "Sacred Yamdrok Lake - turquoise holy lake in Tibet with stunning mountain reflections",
...
export default function TibetanAncientKingdomsTourPage() {
  ...
  const canonicalUrl = "https://www.himkalaadventure.com/destinations/tibet/ancient-kingdoms-tour";
  const pageTitle = "9-Day Tibetan Ancient Kingdoms Tour - Himkala Adventure";
  const pageDescription = "9-Day Tibetan Ancient Kingdoms Tour: Journey through 1,500 years of history from the Yarlung Valley to Sakya, Tsang, and Gyantse kingdoms. Explore Tibet's royal heritage. Book now!";
  const imageUrl = "https://www.himkalaadventure.com/images/used/tibet-kingdom.webp";
  ...
  const orgSchema = {
    ...
    "description": "Expert-guided Tibetan Ancient Kingdoms tour packages. Explore 1,500 years of history in Tibet with certified guides.",
    "address": {
      "@type": "PostalAddress",
  ...
  const tourSchema = {
    "@context": "https://schema.org",
    "@type": "Product",
    "name": "9-Day Tibetan Ancient Kingdoms Tour",
    ...
    "additionalProperty": [
      ...
      {
        "@type": "PropertyValue",
        "name": "Kingdoms Explored",
        "value": "Tibetan Empire, Sakya, Tsang, Gyantse"
      },
      {
        "@type": "PropertyValue",
        "name": "Destinations",
        "value": "Lhasa, Gyantse, Shigatse, Sakya, Yarlung Valley"
      },
      {
        "@type": "PropertyValue",
        "name": "Highlights",
        "value": "Potala Palace, Yumbulagang, Sakya Monastery, Tashilhunpo, Yamdrok Lake"
      }
    ]
  };
        ...
        <section className="relative h-[45vh] min-h-[380px] md:h-[60vh] md:min-h-[500px] overflow-hidden bg-[#0f2940]">
          <div className="absolute inset-0 z-0">
            <Image
              ...
              alt="Tibetan Ancient Kingdoms Tour - exploring 1,500 years of Tibetan royal history in the Roof of the World"
              fill
            ...
            <div className="max-w-5xl mx-auto text-center w-full">
              <div className="flex flex-wrap gap-2 mb-4 md:mb-6 justify-center">
                ...
                <Badge className="bg-amber-100 text-amber-700 border-none font-bold px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm">
                  <Crown className="w-3 h-3 mr-1" aria-hidden="true" /> Ancient Kingdoms
                </Badge>
                <Badge className="bg-purple-100 text-purple-700 border-none font-bold px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm">
                  <History className="w-3 h-3 mr-1" aria-hidden="true" /> 1,500 Years of History
                </Badge>
              </div>
            ...
            <div className="lg:grid lg:grid-cols-12 lg:gap-4 lg:gap-10">
              ...
              <aside className="hidden lg:block lg:col-span-4">
                <div className="sticky top-24 space-y-4 md:space-y-6">
                  ...
                  <Card className="bg-gradient-to-br from-[#0f2940] to-[#1a4166] border-none rounded-xl md:rounded-2xl overflow-hidden">
                    <CardContent className="p-4 md:p-6">
                      ...
                      <div className="space-y-2 md:space-y-3 mb-4 md:mb-6">
                        ...
                        <div className="flex items-center gap-2 md:gap-3 text-white/80 text-xs md:text-sm">
                          <Crown className="w-3 h-3 md:w-4 md:h-4 text-[#C5E0ED]" aria-hidden="true" />
                      ...
                      <a 
                        ...
                        className="block"
                        aria-label="Inquire about Tibetan Ancient Kingdoms tour on WhatsApp"
                      >
                  ...
                  <Card className="bg-[#f8fbfc] border-[#C5E0ED]/30 rounded-xl md:rounded-2xl overflow-hidden">
                    <CardContent className="p-4 md:p-6">
                      <h3 className="font-bold text-[#0f2940] mb-3 md:mb-4 flex items-center gap-2 text-sm md:text-base">
                        <Crown className="w-3 h-3 md:w-4 md:h-4 text-[#2d6a8a]" aria-hidden="true" /> Ancient Kingdoms of Tibet
                      </h3>
              ...
              <article className="lg:col-span-8 w-full overflow-hidden">
                ...
                <section className="mb-6 md:mb-12" id="overview">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Overview of Tibetan Ancient Kingdoms Tour</h2>
                  <div className="prose prose-slate max-w-none">
                    <p className="text-slate-600 leading-relaxed mb-2 md:mb-4 text-xs md:text-base">
                      ...
                      to the powerful dynasties of Sakya, Tsang, and Gyantse, this <strong>Tibet tour</strong> offers an unparalleled 
                ...
                <section className="mb-6 md:mb-12" id="highlights">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Tibetan Ancient Kingdoms Tour Highlights</h2>
                ...
                <section className="mb-6 md:mb-12">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Best Time to Visit Tibet</h2>
                ...
                <section className="mb-6 md:mb-12" id="itinerary">
                  <div className="flex items-center justify-between mb-3 md:mb-6">
                    <h2 className="text-lg md:text-2xl font-serif text-[#0f2940]">Day-by-Day Tibetan Ancient Kingdoms Itinerary</h2>
                    <Button
                      variant="outline"
                      size="sm"
                ...
                <section className="mb-6 md:mb-12" id="includes">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">What's Included in This Tibetan Ancient Kingdoms Tour</h2>
                ...
                <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-4">Important Information for Tibetan Ancient Kingdoms Tour</h2>
                ...
                <section className="mb-6 md:mb-12" id="gallery">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Photo Gallery - Tibetan Ancient Kingdoms Tour</h2>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-1 md:gap-3">
                    {gallery.map((image, i) => (
                      ...
                      >
                        <Image
                          src={image.src}
                          alt={`${image.alt} - Tibetan Ancient Kingdoms tour experience`}
                          fill
                ...
                <section className="mb-6 md:mb-12" id="faq">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Frequently Asked Questions About Tibetan Ancient Kingdoms Tour</h2>
