...
const gallery = [
  ...
  },
  {
    ...
    alt: "Himalayan mountain range viewed from the Tibetan plateau with dramatic peaks",
...
export default function EverestBaseCampTibetPage() {
  ...
  const orgSchema = {
    ...
    "description": "Expert-guided Everest Base Camp from Tibet tours. Drive to the North Face Base Camp at 5,200m with certified guides.",
    "address": {
      "@type": "PostalAddress",
  ...
  const tourSchema = {
    "@context": "https://schema.org",
    "@type": "Product",
    "name": "Everest Base Camp from Tibet - 9 Days",
    ...
    "additionalProperty": [
      ...
      },
      {
        "@type": "PropertyValue",
        "name": "Highlights",
        "value": "Everest Base Camp, Rongbuk Monastery, Potala Palace, Yamdrok Lake"
      }
    ]
  };
            ...
            <div className="max-w-5xl mx-auto text-center w-full">
              <div className="flex flex-wrap gap-2 mb-4 md:mb-6 justify-center">
                ...
                <Badge className="bg-blue-100 text-blue-700 border-none font-bold px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm">
                  <MountainSnow className="w-3 h-3 mr-1" aria-hidden="true" /> 5,200m / 17,060ft
                </Badge>
                <Badge className="bg-amber-100 text-amber-700 border-none font-bold px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm">
                  <Award className="w-3 h-3 mr-1" aria-hidden="true" /> Lifetime Achievement
                </Badge>
              </div>
            ...
            <div className="lg:grid lg:grid-cols-12 lg:gap-4 lg:gap-10">
                ...
                <div className="sticky top-24">
                  <div className="space-y-4 md:space-y-6">
                    ...
                    <Card className="bg-gradient-to-br from-[#0f2940] to-[#1a4166] border-none rounded-xl md:rounded-2xl overflow-hidden">
                      <CardContent className="p-4 md:p-6">
                        ...
                        <a 
                          ...
                          className="block"
                          aria-label="Inquire about Everest Base Camp from Tibet on WhatsApp"
                        >
                    ...
                    <Card className="bg-[#f8fbfc] border-[#C5E0ED]/30 rounded-xl md:rounded-2xl overflow-hidden">
                      <CardContent className="p-4 md:p-6">
                        <h3 className="font-bold text-[#0f2940] mb-3 md:mb-4 flex items-center gap-2 text-[10px] md:text-base">
                          <Mountain className="w-3 h-3 md:w-4 md:h-4 text-[#2d6a8a]" aria-hidden="true" /> Mount Everest Facts
                        </h3>
                        <div className="space-y-2 text-[10px] md:text-sm">
              ...
              <article className="lg:col-span-8 w-full overflow-hidden mt-6 lg:mt-0">
                ...
                <section className="mb-6 md:mb-12" id="overview">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Overview of Everest Base Camp from Tibet</h2>
                ...
                <section className="mb-6 md:mb-12" id="highlights">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Everest Base Camp from Tibet Highlights</h2>
                ...
                <section className="mb-6 md:mb-12">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Best Time to Visit Everest from Tibet</h2>
                ...
                <section className="mb-6 md:mb-12" id="itinerary">
                  <div className="flex items-center justify-between mb-3 md:mb-6">
                    <h2 className="text-lg md:text-2xl font-serif text-[#0f2940]">Day-by-Day Everest Base Camp from Tibet Itinerary</h2>
                    <Button
                      variant="outline"
                      size="sm"
                ...
                <section className="mb-6 md:mb-12" id="includes">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">What's Included in This Everest Base Camp from Tibet Tour</h2>
                ...
                <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-4">Important Information for Everest Base Camp from Tibet</h2>
                ...
                <section className="mb-6 md:mb-12" id="gallery">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Photo Gallery - Everest Base Camp from Tibet</h2>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-1 md:gap-3">
                    {gallery.map((image, i) => (
                      ...
                      >
                        <Image
                          src={image.src}
                          alt={`${image.alt} - Everest Base Camp from Tibet tour experience`}
                          fill
                ...
                <section className="mb-6 md:mb-12" id="faq">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Frequently Asked Questions About Everest Base Camp from Tibet</h2>
