                  ...
                  <CardContent className="p-4 md:p-6">
                    ...
                    <div className="space-y-3 text-xs md:text-sm">
                      {altitudeInfo.map((item, index) => (
                        <div key={index} className="flex items-start gap-2 border-b border-[#C5E0ED]/20 last:border-0 pb-2 last:pb-0">
                          <div className="w-16 font-medium text-[#0f2940]">{item.location}</div>
                          <div className="flex-1">
                            <div className="flex items-center gap-2">
                              <span className="text-slate-600">{item.altitude}</span>
                              <span className="text-slate-400 text-[10px]">{item.overnight}</span>
                            </div>
                            <p className="text-slate-500 text-[10px]">{item.notes}</p>
                          </div>
                        </div>
                      ))}
                      <div className="mt-2 bg-amber-50 p-2 rounded-lg">
                        <p className="text-amber-700 text-[10px] flex items-start gap-1">
