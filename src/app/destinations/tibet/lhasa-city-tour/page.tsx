...
export default function LhasaCityTourPage() {
  ...
  const orgSchema = {
    ...
    "description": "Expert-guided Lhasa City Tours. Explore Potala Palace, Jokhang Temple, and Tibetan monasteries with certified guides.",
    "address": {
      "@type": "PostalAddress",
  ...
  const tourSchema = {
    ...
    "additionalProperty": [
      ...
      },
      {
        "@type": "PropertyValue",
        "name": "Highlights",
        "value": "Potala Palace, Jokhang Temple, Barkhor Circuit, Sera Monastery, Drepung Monastery"
      }
    ]
  };
              ...
              <div className="mt-8 pt-6 border-t border-slate-200">
                <div className="flex gap-2">
                  <Button
                    ...
                    aria-label="Share Lhasa City Tour on Facebook"
                  >
                  ...
                  <Button
                    ...
                    aria-label="Share Lhasa City Tour on Twitter"
                  >
                  ...
                  <Button
                    ...
                    aria-label="Copy Lhasa City Tour link to clipboard"
                  >
          ...
          <div className="max-w-5xl mx-auto text-center w-full">
            <div className="flex flex-wrap gap-2 mb-4 md:mb-6 justify-center">
              ...
              <Badge className="bg-blue-100 text-blue-700 border-none font-bold px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm">
                <Landmark className="w-3 h-3 mr-1" aria-hidden="true" /> UNESCO World Heritage
              </Badge>
            </div>
          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-4 lg:gap-10">
              ...
              <div className="sticky top-24">
                <div className="space-y-4 md:space-y-6">
                  ...
                  <Card className="bg-gradient-to-br from-[#0f2940] to-[#1a4166] border-none rounded-xl md:rounded-2xl overflow-hidden">
                    <CardContent className="p-4 md:p-6">
                      ...
                      <a 
                        ...
                        aria-label="Inquire about Lhasa City Tour on WhatsApp"
                      >
                  ...
                  <Card className="bg-[#f8fbfc] border-[#C5E0ED]/30 rounded-xl md:rounded-2xl overflow-hidden">
                    <CardContent className="p-4 md:p-6">
                      <h3 className="font-bold text-[#0f2940] mb-3 md:mb-4 flex items-center gap-2 text-[10px] md:text-base">
                        <Info className="w-3 h-3 md:w-4 md:h-4 text-[#2d6a8a]" aria-hidden="true" /> Lhasa Facts
                      </h3>
                      <div className="space-y-2 text-[10px] md:text-sm">
            ...
            <article className="lg:col-span-8 w-full overflow-hidden mt-6 lg:mt-0">
              ...
              <section className="mb-6 md:mb-12" id="overview">
                <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Overview of Lhasa City Tour</h2>
              ...
              <section className="mb-6 md:mb-12" id="highlights">
                <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Lhasa City Tour Highlights</h2>
              ...
              <section className="mb-6 md:mb-12">
                <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Best Time to Visit Lhasa</h2>
              ...
              <section className="mb-6 md:mb-12" id="itinerary">
                <div className="flex items-center justify-between mb-3 md:mb-6">
                  <h2 className="text-lg md:text-2xl font-serif text-[#0f2940]">Day-by-Day Lhasa City Itinerary</h2>
                  <Button
                    variant="outline"
                    size="sm"
              ...
              <section className="mb-6 md:mb-12" id="includes">
                <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">What's Included in Lhasa City Tour</h2>
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg md:rounded-2xl p-3 md:p-6 flex gap-2 md:gap-4 mb-6 md:mb-12">
                ...
                <div>
                  <h3 className="font-bold text-amber-800 mb-1 md:mb-2 text-xs md:text-base">Important Information - Lhasa Travel</h3>
              ...
              <section className="mb-6 md:mb-12" id="gallery">
                <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Lhasa City Photo Gallery</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 gap-1 md:gap-3">
                  {gallery.map((image, i) => (
                    ...
                    >
                      <Image
                        src={image.src}
                        alt={`${image.alt} - Lhasa City Tour experience`}
                        fill
              ...
              <section className="mb-6 md:mb-12" id="faq">
                <h2 className="text-lg md:text-2xl font-serif text-[#0f2940] mb-2 md:mb-4">Frequently Asked Questions About Lhasa City Tour</h2>
