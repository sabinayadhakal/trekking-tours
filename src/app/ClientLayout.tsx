  ...
  <div className="container mx-auto px-4 sm:px-6 py-3 md:py-4 flex items-center justify-between relative">
    ...
    <div className="hidden md:flex items-center gap-4 lg:gap-6 relative z-10">
      ...
      {[
        ...
        { label: "Treks", href: "/trekking" },
        { label: "City Tours", href: "/city_tours" },
      ...
      <a 
        href="https://wa.me/97714123456?text=Hello%20Himkala%20Adventure!%20I'm%20interested%20in%20your%20services."
        target="_blank"
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                >
                  ...
                  <span className="font-medium">Speak With Expert</span>
                </Button>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-white/60">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <a href="tel:+97714123456" className="hover:text-[#C5E0ED] transition-colors">
                    +977 1 4123456
                  </a>
                </li>
                <li className="flex items-start gap-3">
