...
const trekkingPages = [
  ...
  { path: '/services/trekking/manaslu-circuit-trek', priority: 0.85, changefreq: 'weekly' },
  { path: '/services/trekking/manaslu-circuit-trek-with-tsum-valley', priority: 0.8, changefreq: 'weekly' },
