...
export default function BlogPostPage() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#f2ede4] overflow-x-hidden">
            ...
            <div className="absolute right-0 top-0 bottom-0 w-4/5 max-w-sm bg-[#f7f2e9] shadow-xl">
              <div className="p-6 h-full overflow-y-auto">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="font-bold text-lg text-[#14383b] flex items-center gap-2">
                    <Menu className="w-5 h-5 text-[#cf6943]" /> Contents
                  </h3>
                  <button 
                    onClick={() => setShowMobileTOC(false)}
                    className="p-2 rounded-lg hover:bg-[#e4d8c8]"
                ...
                <div className="mt-8 pt-6 border-t border-[#d8cec0]">
                  <div className="flex gap-2">
                    ...
                    <Button
                      size="sm"
                      className="flex-1 bg-[#14383b] hover:bg-[#0d2427] text-[#f7f2e9]"
        ...
        {/* Hero Section */}
        <section className="relative h-[45vh] min-h-[380px] md:h-[60vh] md:min-h-[500px] overflow-hidden bg-[#0d2427]">
          <div className="absolute inset-0 z-0">
            <Image
              ...
              sizes="100vw"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#0d2427] via-[#0d2427]/50 to-transparent" />
            <div className="absolute inset-0 bg-gradient-to-t from-[#0d2427]/80 via-transparent to-transparent" />
          </div>

          <div className="absolute inset-0 flex items-center justify-center z-10 px-4">
            <div className="max-w-4xl mx-auto text-center w-full">
              <Badge className="mb-4 bg-[#f7f2e9]/20 backdrop-blur-sm text-[#f7f2e9] border-[#f7f2e9]/30 py-1.5 px-3 text-xs font-medium">
                <Tag className="w-3 h-3 mr-1.5" /> {blogPost.category}
              </Badge>
              
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif text-[#f7f2e9] leading-tight mb-4 md:mb-6 px-2">
                {blogPost.title}
              </h1>
              
              <p className="text-sm sm:text-base md:text-lg text-[#f7f2e9]/90 max-w-2xl mx-auto leading-relaxed mb-8 md:mb-10 font-light px-2 sm:px-0">
                {blogPost.excerpt}
              </p>
              
              <div className="flex flex-col items-center justify-center gap-4 text-xs sm:text-sm text-[#f7f2e9]/70">
                <div className="flex flex-col sm:flex-row items-center gap-4">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full overflow-hidden border-2 border-[#f0a17f] bg-[#f7f2e9]/10 flex items-center justify-center">
                      <User className="w-5 h-5 text-[#f7f2e9]" />
                    </div>
                    <div className="text-center sm:text-left">
                      <p className="font-bold text-[#f7f2e9] text-sm sm:text-base">{blogPost.author.name}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    <span className="flex items-center gap-1.5">
                      <Calendar className="w-3 h-3 sm:w-4 sm:h-4 text-[#f0a17f]" /> 
                      <span>{blogPost.date}</span>
                    </span>
                    <span className="flex items-center gap-1.5">
                      <Clock className="w-3 h-3 sm:w-4 sm:h-4 text-[#f0a17f]" /> 
                      {blogPost.readTime}
                    </span>
                  </div>
                </div>
            ...
            <div className="grid lg:grid-cols-12 gap-8">
              ...
              <aside className="hidden lg:block lg:col-span-3">
                <div className="sticky top-24 space-y-6">
                  <Card className="bg-[#f7f2e9] border-[#d8cec0]/50 rounded-2xl overflow-hidden">
                    <CardContent className="p-6">
                      <h2 className="font-bold text-[#14383b] mb-4 flex items-center gap-2 text-lg">
                  ...
                  <Card className="bg-gradient-to-br from-[#0d2427] to-[#14383b] border-none rounded-2xl overflow-hidden">
                    <CardContent className="p-6">
                      <h3 className="font-bold text-[#f7f2e9] mb-4 flex items-center gap-2 text-lg">
                      ...
                      <div className="flex gap-2">
                        ...
                        <Button
                          size="sm"
                          className="flex-1 bg-[#f7f2e9]/10 hover:bg-[#f7f2e9]/20 text-[#f7f2e9] rounded-xl"
                          onClick={handleCopyLink}
                          aria-label="Copy link to article"
                        >
                          {copied ? <Check className="w-4 h-4" /> : <Copy className="w-4 h-4" />}
                  ...
                  <Card className="bg-gradient-to-br from-[#e47a4f]/20 to-[#cf6943]/20 border-[#e47a4f]/30 rounded-2xl overflow-hidden">
                    <CardContent className="p-6 text-center">
                      <Mountain className="w-8 h-8 text-[#cf6943] mx-auto mb-3" />
                      <h3 className="font-bold text-[#14383b] mb-2">Ready for Your First Trek?</h3>
                      ...
                      <Link href="/services/trekking" className="block">
                        <Button className="bg-[#e47a4f] hover:bg-[#cf6943] text-[#f7f2e9] w-full rounded-xl">
                          Plan My Trek
                        </Button>
                      </Link>
                    </CardContent>
              ...
              <article className="lg:col-span-9 overflow-x-hidden">
                <div className="max-w-full prose prose-sm md:prose-base prose-slate prose-headings:font-serif prose-headings:text-[#14383b] prose-a:text-[#cf6943] prose-a:no-underline hover:prose-a:underline prose-strong:text-[#14383b]">
                  {/* Introduction */}
                  <section id="introduction" className="mb-8 md:mb-12">
                    <p className="text-base md:text-lg text-[#556363] leading-relaxed mb-4 first-letter:text-4xl md:first-letter:text-6xl first-letter:font-serif first-letter:text-[#14383b] first-letter:float-left first-letter:mr-3 first-letter:mt-1">
                    ...
                    <p className="text-[#556363] leading-relaxed mb-4">
                    ...
                    <p className="text-[#556363] leading-relaxed">
                  ...
                  <section id="nagarkot" className="mb-8 md:mb-12">
                    <h2 className="text-xl md:text-2xl lg:text-3xl font-serif text-[#14383b] mb-4 flex items-center gap-3">
                      <span className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-br from-[#e47a4f] to-[#cf6943] rounded-lg md:rounded-xl flex items-center justify-center text-[#f7f2e9]">
                    ...
                    <div className="bg-[#e4d8c8] rounded-xl p-4 md:p-5 mb-4">
                      <h4 className="font-bold text-[#14383b] mb-2">At a Glance:</h4>
                      <div className="grid grid-cols-2 gap-3 text-xs md:text-sm text-[#556363]">
                    ...
                    <Link href="/services/day-hikings/nagarkot-changunarayan-hiking" className="inline-block">
                      <Button className="bg-[#e47a4f] hover:bg-[#cf6943] text-[#f7f2e9] rounded-full px-4 md:px-6 py-2 text-xs md:text-sm">
                    ...
                    <div className="relative h-[250px] md:h-[350px] rounded-xl md:rounded-2xl overflow-hidden my-6 w-full">
                      <Image
                        ...
                        alt="Sunrise view from Nagarkot with Himalayan peaks stretching across the horizon in Nepal"
                        fill
                  ...
                  <section id="namobuddha" className="mb-8 md:mb-12">
                    ...
                    <div className="bg-[#e4d8c8] rounded-xl p-4 md:p-5 my-4">
                      <h4 className="font-bold text-[#14383b] mb-2">At a Glance:</h4>
                      <div className="grid grid-cols-2 gap-3 text-xs md:text-sm text-[#556363]">
                        <div><span className="font-medium text-[#cf6943]">Time:</span> One day</div>
                    ...
                    <div className="relative h-[250px] md:h-[350px] rounded-xl md:rounded-2xl overflow-hidden my-6 w-full">
                      <Image
                        ...
                        alt="Thrangu Tashi Yangtse Monastery at Namobuddha with golden rooftops and prayer flags in Nepal"
                        fill
                        className="object-cover"
                        sizes="(max-width: 768px) 100vw, 80vw"
                        loading="lazy"
                  ...
                  <section id="poonhill" className="mb-8 md:mb-12">
                    ...
                    <div className="relative h-[250px] md:h-[350px] rounded-xl md:rounded-2xl overflow-hidden my-6 w-full">
                      <Image
                        ...
                        alt="Spectacular sunrise view from Poon Hill with Annapurna mountain range glowing in golden light in Nepal"
                        fill
                        className="object-cover"
                        sizes="(max-width: 768px) 100vw, 80vw"
                        loading="lazy"
                  ...
                  <section id="mardi" className="mb-8 md:mb-12">
                    ...
                    <div className="relative h-[250px] md:h-[350px] rounded-xl md:rounded-2xl overflow-hidden my-6 w-full">
                      <Image
                        ...
                        alt="Mardi Himal Base Camp with Machhapuchhre (Fishtail) mountain towering in the background in Nepal"
                        fill
                        className="object-cover"
                        sizes="(max-width: 768px) 100vw, 80vw"
                        loading="lazy"
                  ...
                  <section id="langtang" className="mb-8 md:mb-12">
                    ...
                    <div className="relative h-[250px] md:h-[350px] rounded-xl md:rounded-2xl overflow-hidden my-6 w-full">
                      ...
                      />
                      <div className="absolute bottom-2 left-2 right-2 bg-black/60 backdrop-blur-sm text-white text-xs px-3 py-1.5 rounded-lg flex items-center gap-1">
                        <Camera className="w-3 h-3" /> Views from Kyanjin Ri
                      </div>
                    </div>
                  </section>
                  ...
                  <section id="faq" className="mb-8 md:mb-12">
                    ...
                    <div className="space-y-4 mt-4">
                      <div className="bg-[#f7f2e9] rounded-xl p-4 md:p-5 border border-[#d8cec0]/50">
                        <h3 className="font-bold text-[#14383b] text-sm md:text-base mb-2">Do I need a guide to trek in Nepal?</h3>
                        <p className="text-[#556363] text-xs md:text-sm leading-relaxed">
                      ...
                      <div className="bg-[#f7f2e9] rounded-xl p-4 md:p-5 border border-[#d8cec0]/50">
                        <h3 className="font-bold text-[#14383b] text-sm md:text-base mb-2">How physically fit do I need to be?</h3>
                        <p className="text-[#556363] text-xs md:text-sm leading-relaxed">
                      ...
                      <div className="bg-[#f7f2e9] rounded-xl p-4 md:p-5 border border-[#d8cec0]/50">
                        <h3 className="font-bold text-[#14383b] text-sm md:text-base mb-2">What should I pack?</h3>
                        <p className="text-[#556363] text-xs md:text-sm leading-relaxed mb-2">
                    ...
                    <div className="grid grid-cols-2 gap-3 md:gap-4 mt-6">
                      <div className="relative h-[150px] md:h-[200px] rounded-xl overflow-hidden">
                        <Image
                          ...
                          alt="Trekker on a mountain ridge with panoramic Himalayan views in Nepal"
                          fill
                          className="object-cover"
                          loading="lazy"
                          quality={75}
                      ...
                      <div className="relative h-[150px] md:h-[200px] rounded-xl overflow-hidden">
                        <Image
                          ...
                          alt="Himalayan mountain range at golden hour with snow-capped peaks in Nepal"
                          fill
                          className="object-cover"
                          loading="lazy"
                          quality={75}
                  ...
                  <Card className="bg-gradient-to-br from-[#f7f2e9] to-[#e4d8c8] border-[#d8cec0]/50 rounded-xl md:rounded-2xl overflow-hidden">
                    <CardContent className="p-4 md:p-6 lg:p-8">
                      <div className="flex flex-col md:flex-row gap-4 md:gap-6 items-center md:items-start">
                        <div className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 rounded-lg md:rounded-xl lg:rounded-2xl overflow-hidden border-4 border-[#f7f2e9] shadow-lg flex items-center justify-center bg-[#14383b]/10">
                          <User className="w-8 h-8 text-[#cf6943]" />
                        </div>
                        <div className="text-center md:text-left">
                          <p className="text-xs font-bold text-[#cf6943] uppercase tracking-wider mb-1 md:mb-2">Written By</p>
                          <h3 className="text-lg md:text-xl font-bold text-[#14383b] mb-1">{blogPost.author.name}</h3>
                          <a 
                            href={blogPost.author.linkedin}
                            target="_blank" 
                            rel="noopener noreferrer nofollow"
                            className="inline-flex items-center gap-2 text-sm text-[#cf6943] hover:text-[#14383b] transition-colors mt-2"
                  ...
                  <div className="lg:hidden mt-6">
                    <div className="flex flex-col gap-3">
                      ...
                      <Button
                        variant="outline"
                        className="w-full border-[#d8cec0] text-[#14383b] hover:bg-[#e4d8c8]"
                        onClick={handleCopyLink}
                        aria-label="Copy link to article"
                      >
                        {copied ? (
                  ...
                  <div className="flex flex-wrap gap-2 mt-6 md:mt-8">
                    {blogPost.tags.map((tag) => (
                      <Badge key={tag} variant="outline" className="border-[#d8cec0] text-[#556363] hover:bg-[#e4d8c8] cursor-pointer rounded-full px-3 py-1 text-xs md:text-sm">
                        #{tag}
                      </Badge>
                    ))}
                  </div>
        ...
        {/* Related Posts */}
        <section className="py-12 md:py-20 bg-[#e4d8c8]">
          <div className="container mx-auto px-4 md:px-6">
            <div className="mb-8 md:mb-12 text-center">
              <h2 className="text-xs md:text-sm font-bold text-[#cf6943] uppercase tracking-[0.25em] mb-3 md:mb-4">Continue Your Journey</h2>
              <h3 className="text-2xl md:text-3xl lg:text-4xl font-serif text-[#14383b]">More Insights from Us</h3>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
              {relatedPosts.map((post, i) => (
                <Link href={post.href} key={i} className="block">
                  <Card className="bg-[#f7f2e9] border-[#d8cec0]/50 rounded-xl md:rounded-2xl overflow-hidden h-full hover:shadow-lg hover:shadow-[#14383b]/10 transition-all duration-300 group cursor-pointer">
                    ...
                    <CardContent className="p-4 md:p-6">
                      <h4 className="text-base md:text-lg font-bold text-[#14383b] mb-2 md:mb-3 leading-snug group-hover:text-[#cf6943] transition-colors line-clamp-2">
                        {post.title}
                      </h4>
                      <div className="flex items-center gap-3 md:gap-4 text-xs text-[#556363]">
