...
const relatedPosts = [
  {
    title: "Sacred Cows and Stray Dogs: Understanding Nepal's Unique Animal Ethics",
    image: "https://images.unsplash.com/photo-1583337130417-3346a1be7dee?q=80&w=800&auto=format&fit=crop",
    date: "April 22, 2026",
    readTime: "7 min",
  },
  {
    title: "The Hidden Life of Urban Animals: How Cities Shape Wildlife Behavior",
    image: "https://images.unsplash.com/photo-1548199973-03cce0bbc87b?q=80&w=800&auto=format&fit=crop",
    date: "March 15, 2026",
    readTime: "8 min",
  },
  {
    title: "Festivals of Nepal: Where Every Creature Finds a Blessing",
    image: "https://images.unsplash.com/photo-1558799401-1dcba79834c2?q=80&w=800&auto=format&fit=crop",
      ...
      <section className="py-12 md:py-20 bg-gradient-to-b from-[#f0f7fa] to-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="text-center mt-12">
            <Link href="/blog">
              <Button className="bg-[#0f2940] hover:bg-[#1a4166] text-white rounded-full px-8">
                Explore All Stories
              </Button>
            </Link>
          </div>
