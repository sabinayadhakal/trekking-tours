...
export default function BlogPostPage() {
  ...
  const blogSchema = {
    ...
    "keywords": "pigeons Nepal, cultural contrasts Nepal Europe, urban wildlife Nepal, pigeon symbolism Hinduism, Kathmandu pigeons, Nepali culture traditions",
      ...
      <section className="relative h-[45vh] min-h-[380px] md:h-[60vh] md:min-h-[500px] overflow-hidden bg-[#0f2940]">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="Pigeons gathered at a temple courtyard in Kathmandu, Nepal - sacred birds in Hindu and Buddhist culture"
            fill
              ...
              <div className="sticky top-24 space-y-6">
                <Card className="bg-white border-[#C5E0ED]/30 rounded-2xl overflow-hidden">
                  <CardContent className="p-6">
                    <h2 className="font-bold text-[#0f2940] mb-4 flex items-center gap-2 text-base">
                      <Bird className="w-4 h-4 text-[#2d6a8a]" aria-hidden="true" /> Table of Contents
                    </h2>
                    <nav className="space-y-2" aria-label="Table of contents">
                      {tableOfContents.map((item) => (
                        <button
                ...
                <Card className="bg-gradient-to-br from-amber-50 to-orange-50 border-amber-200 rounded-2xl overflow-hidden">
                  <CardContent className="p-6 text-center">
                    ...
                    <h3 className="font-bold text-amber-800 mb-2 text-base">Experience Nepal's Culture Firsthand</h3>
                    ...
                    <Link href="/services/day-sightseeings" className="block">
                      <Button className="bg-amber-600 hover:bg-amber-700 text-white w-full rounded-xl" aria-label="Explore cultural tours and treks with Himkala Adventure">
                        Explore Our Tours
                      </Button>
                    </Link>
                  </CardContent>
              ...
              <div className="max-w-none">
                ...
                <div className="relative h-[250px] md:h-[400px] rounded-xl md:rounded-2xl overflow-hidden my-8 md:my-12">
                  <Image
                    ...
                    alt="Devotee feeding pigeons at a temple courtyard in Kathmandu, Nepal - sacred ritual in Hindu culture"
                    fill
                  ...
                  <div className="absolute bottom-2 left-2 right-2 bg-black/60 backdrop-blur-sm text-white text-xs px-3 py-1.5 rounded-lg flex items-center gap-1">
                    <Camera className="w-3 h-3" aria-hidden="true" /> Devotees feeding pigeons at a temple courtyard in Kathmandu, Nepal
                  </div>
                </div>
                ...
                <section id="religious-significance" className="mb-8 md:mb-12">
                  <h2 className="text-xl md:text-2xl lg:text-3xl font-serif text-[#0f2940] mb-4 flex items-center gap-3">
                    <span className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-br from-[#C5E0ED] to-[#9dcae0] rounded-lg md:rounded-xl flex items-center justify-center text-[#0f2940]">
                      <Landmark className="w-4 h-4 md:w-5 md:h-5" aria-hidden="true" />
                    </span>
                  ...
                  <div className="grid md:grid-cols-2 gap-4 mt-6">
                    <Card className="bg-gradient-to-br from-[#C5E0ED]/20 to-[#e8f4f8] border-[#C5E0ED]/30 rounded-xl">
                      <CardContent className="p-5">
                        <h3 className="font-bold text-[#0f2940] mb-2 flex items-center gap-2 text-sm md:text-base">
                          <Shield className="w-4 h-4 text-[#2d6a8a]" aria-hidden="true" /> Bhagwan's Mount
                        </h3>
                    ...
                    <Card className="bg-gradient-to-br from-[#C5E0ED]/20 to-[#e8f4f8] border-[#C5E0ED]/30 rounded-xl">
                      <CardContent className="p-5">
                        <h3 className="font-bold text-[#0f2940] mb-2 flex items-center gap-2 text-sm md:text-base">
                          <Globe className="w-4 h-4 text-[#2d6a8a]" aria-hidden="true" /> Buddhist Connections
                        </h3>
                        <p className="text-slate-600 text-sm">
                ...
                <section id="feeding-culture" className="mb-8 md:mb-12">
                  <h2 className="text-xl md:text-2xl lg:text-3xl font-serif text-[#0f2940] mb-4 flex items-center gap-3">
                    <span className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-br from-[#C5E0ED] to-[#9dcae0] rounded-lg md:rounded-xl flex items-center justify-center text-[#0f2940]">
                      <Droplets className="w-4 h-4 md:w-5 md:h-5" aria-hidden="true" />
                    </span>
                ...
                <section id="europe-perspective" className="mb-8 md:mb-12">
                  <h2 className="text-xl md:text-2xl lg:text-3xl font-serif text-[#0f2940] mb-4 flex items-center gap-3">
                    <span className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-br from-[#C5E0ED] to-[#9dcae0] rounded-lg md:rounded-xl flex items-center justify-center text-[#0f2940]">
                      <AlertTriangle className="w-4 h-4 md:w-5 md:h-5" aria-hidden="true" />
                    </span>
                  ...
                  <div className="bg-red-50 border border-red-200 rounded-xl p-5 mt-4">
                    <h3 className="font-bold text-red-700 mb-2 flex items-center gap-2 text-sm md:text-base">
                      <AlertTriangle className="w-4 h-4" aria-hidden="true" /> The Turning Point
                    </h3>
                      ...
                      <CardContent className="p-4 space-y-2">
                        {[
                          ...
                          <div key={i} className="flex items-center gap-2 text-sm text-slate-700">
                            <Heart className="w-3 h-3 text-green-600" aria-hidden="true" />
                            <span>{item}</span>
                          </div>
                        ))}
                      </CardContent>
                  ...
                  <div className="space-y-3 mt-4">
                    {[
                      ...
                      <div key={i} className="flex gap-3 p-3 md:p-4 bg-gradient-to-r from-[#C5E0ED]/20 to-transparent rounded-lg md:rounded-xl border-l-4 border-[#2d6a8a]">
                        <Lightbulb className="w-4 h-4 md:w-5 md:h-5 text-[#2d6a8a] shrink-0 mt-0.5" aria-hidden="true" />
                        <div>
                          <h3 className="font-bold text-[#0f2940] mb-1 text-sm md:text-base">{item.lesson}</h3>
                ...
                <section id="conclusion" className="mb-8 md:mb-12">
                  <h2 className="text-xl md:text-2xl lg:text-3xl font-serif text-[#0f2940] mb-4 flex items-center gap-3">
                    <span className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-br from-[#C5E0ED] to-[#9dcae0] rounded-lg md:rounded-xl flex items-center justify-center text-[#0f2940]">
                      <Bird className="w-4 h-4 md:w-5 md:h-5" aria-hidden="true" />
                    </span>
