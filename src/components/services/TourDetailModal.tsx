...
import { X, Star, MapPin, Check, X as XIcon, Mountain, Gauge, AlertCircle } from "lucide-react"
...
export default function TourDetailModal({ tour, isOpen, onClose }: TourDetailModalProps) {
  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        className="bg-[#EAF2FF] max-w-4xl w-full max-h-[90vh] rounded-lg shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300 transition-transform transform hover:scale-[1.01]"
      >
        {/* Header */}
        ...
        <div className="p-6 overflow-y-auto overscroll-contain scroll-smooth space-y-4 animate-in fade-in-0 duration-500 max-h-[calc(90vh-88px)]">
          {/* Location & Rating */}
            ...
            {activeTab === "overview" ? (
              <>
                ...
                {tour.entryRequirements && (
                  <div>
                    <h3 className="font-semibold mb-2 text-[#3C6AA6]">Nepal Entry Requirements</h3>
                    <ul className="space-y-1">
